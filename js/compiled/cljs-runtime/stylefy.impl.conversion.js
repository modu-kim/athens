...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54392_SHARP_){
return handle_mode(p1__54392_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__54392_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54393_SHARP_){
return handle_mode(cljs.core.first(p1__54393_SHARP_),cljs.core.second(p1__54393_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__54394,options){
...
var style = map__54395__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54395__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54395__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54395__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__54397,options){
...
var style = map__54398__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__54408,options){
var map__54409 = p__54408;
var map__54409__$1 = (((((!((map__54409 == null))))?(((((map__54409.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54409.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54409):map__54409);
var style = map__54409__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54409__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54409__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54409__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__54414,options){
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__54413_SHARP_){
if(cljs.core.map_QMARK_(p1__54413_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__54413_SHARP_);
} else {
return p1__54413_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__54419,options){
var map__54420 = p__54419;
var map__54420__$1 = (((((!((map__54420 == null))))?(((((map__54420.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54420.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54420):map__54420);
var style = map__54420__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54420__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54420__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
