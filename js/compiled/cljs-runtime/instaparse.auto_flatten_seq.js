...
if((cljs.core.peek(index) < ((function (){var G__46498 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46498) : instaparse.auto_flatten_seq.true_count.call(null,G__46498));
})() - (1)))){
...
while(true){
if((!((coll__$1 == null)))){
var G__46583 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__46584 = cljs.core.next(coll__$1);
unmixed_hash = G__46583;
coll__$1 = G__46584;
continue;
} else {
return unmixed_hash;
...
var G__46585 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__46586 = cljs.core.next(v);
acc = G__46585;
v = G__46586;
continue;
} else {
var G__46587 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__46588 = cljs.core.next(v);
acc = G__46587;
v = G__46588;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46590 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46590(self);
}
});
...
var self__ = this;
var self__ = this;
var G__46565 = (arguments.length - (1));
switch (G__46565) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args46555){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args46555)));
}));
