...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_46564 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_46564(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_46565 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_46565(self);
}
});
...
var G__46566 = n__$1;
var G__46567 = y;
var G__46568 = cljs.core.imul(z,z);
n = G__46566;
y = G__46567;
z = G__46568;
continue;
...
var G__46569 = n__$1;
var G__46570 = cljs.core.imul(z,y);
var G__46571 = cljs.core.imul(z,z);
n = G__46569;
y = G__46570;
z = G__46571;
continue;
...
var G__46572 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__46573 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__46572;
index__$1 = G__46573;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__46491 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46491) : instaparse.auto_flatten_seq.true_count.call(null,G__46491));
})() - (1)))){
...
var G__46574 = v;
var G__46575 = cljs.core.pop(index);
v = G__46574;
index = G__46575;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__46581 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__46582 = cljs.core.next(coll__$1);
unmixed_hash = G__46581;
coll__$1 = G__46582;
continue;
} else {
return unmixed_hash;
...
var G__46584 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__46585 = cljs.core.next(v);
acc = G__46584;
v = G__46585;
continue;
} else {
var G__46586 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__46587 = cljs.core.next(v);
acc = G__46586;
v = G__46587;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46588 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46588(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args46550){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args46550)));
}));
