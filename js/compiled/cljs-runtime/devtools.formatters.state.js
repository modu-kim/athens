...
var len__4736__auto___23498 = arguments.length;
var i__4737__auto___23499 = (0);
while(true){
if((i__4737__auto___23499 < len__4736__auto___23498)){
args__4742__auto__.push((arguments[i__4737__auto___23499]));

var G__23500 = (i__4737__auto___23499 + (1));
i__4737__auto___23499 = G__23500;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq23490){
var G__23491 = cljs.core.first(seq23490);
var seq23490__$1 = cljs.core.next(seq23490);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23491,seq23490__$1);
}));
...
return cljs.core.some((function (p1__23496_SHARP_){
return (p1__23496_SHARP_ === object);
}),history);
});
