...
var len__4736__auto___53264 = arguments.length;
var i__4737__auto___53265 = (0);
while(true){
if((i__4737__auto___53265 < len__4736__auto___53264)){
args__4742__auto__.push((arguments[i__4737__auto___53265]));

var G__53266 = (i__4737__auto___53265 + (1));
i__4737__auto___53265 = G__53266;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__53255_SHARP_){
return (p1__53255_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__53255_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__53255_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq53256){
...
var map__53257 = temp__5733__auto__;
var map__53257__$1 = (((((!((map__53257 == null))))?(((((map__53257.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53257.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53257):map__53257);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53257__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53257__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53257__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__53268 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__53269 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__53260 = tag;
