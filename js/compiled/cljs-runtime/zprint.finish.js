...
var G__28237 = cljs.core.next(ssv);
var G__28238 = (this_ssv == null);
var G__28239 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28240 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28237;
doing_nil_QMARK_ = G__28238;
last_elide = G__28239;
out = G__28240;
continue;
}
...
var G__28242 = cljs.core.next(remaining_cvec);
var G__28243 = new_idx;
var G__28244 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28242;
idx = G__28243;
out = G__28244;
continue;
}
...
var vec__28208 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(1),null);
var cvec_element = vec__28208;
...
var G__28262 = (idx + (1));
var G__28263 = idx;
var G__28264 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28261;
idx = G__28262;
start = G__28263;
out = G__28264;
...
var G__28266 = (idx + (1));
var G__28267 = (idx + (1));
var G__28268 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28265;
idx = G__28266;
start = G__28267;
out = G__28268;
...
var G__28270 = (idx + (1));
var G__28271 = idx;
var G__28272 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28269;
idx = G__28270;
start = G__28271;
out = G__28272;
...
var G__28273 = cljs.core.next(cvec_nl);
var G__28274 = (idx + (1));
var G__28275 = start;
var G__28276 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28273;
idx = G__28274;
start = G__28275;
out = G__28276;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28213_SHARP_,p2__28212_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28212_SHARP_)){
return cljs.core.reduced(p1__28213_SHARP_);
} else {
return (p1__28213_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28214,p__28215){
var vec__28216 = p__28214;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28216,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28216,(1),null);
var vec__28219 = p__28215;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28219,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28219,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28227,cvec,focus_vec){
var map__28228 = p__28227;
var map__28228__$1 = (((((!((map__28228 == null))))?(((((map__28228.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28228.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28228):map__28228);
var options = map__28228__$1;
var map__28229 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28228__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28229__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28229__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28229__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28226_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28226_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
