 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__28155){
var vec__28156 = p__28155;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28156,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28156,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
...
var G__28235 = cljs.core.next(ssv);
var G__28236 = (this_ssv == null);
var G__28237 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28238 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28235;
doing_nil_QMARK_ = G__28236;
last_elide = G__28237;
out = G__28238;
continue;
}
...
var G__28239 = cljs.core.next(remaining_cvec);
var G__28240 = new_idx;
var G__28241 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28239;
idx = G__28240;
out = G__28241;
continue;
}
...
var G__28253 = cljs.core.next(cvec_nl);
var G__28254 = (idx + (1));
var G__28255 = start;
var G__28256 = out;
cvec_nl = G__28253;
...
var G__28257 = cljs.core.next(cvec_nl);
var G__28258 = (idx + (1));
var G__28259 = idx;
var G__28260 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28257;
idx = G__28258;
start = G__28259;
out = G__28260;
...
var G__28261 = cljs.core.next(cvec_nl);
var G__28262 = (idx + (1));
var G__28263 = (idx + (1));
var G__28264 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28261;
idx = G__28262;
start = G__28263;
out = G__28264;
...
var G__28270 = cljs.core.next(cvec_nl);
var G__28271 = (idx + (1));
var G__28272 = start;
var G__28273 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28270;
idx = G__28271;
start = G__28272;
out = G__28273;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28212_SHARP_,p2__28211_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28211_SHARP_)){
return cljs.core.reduced(p1__28212_SHARP_);
} else {
return (p1__28212_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28213,p__28214){
var vec__28215 = p__28213;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28215,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28215,(1),null);
var vec__28218 = p__28214;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28223,cvec,focus_vec){
...
var options = map__28224__$1;
var map__28226 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28224__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__28226__$1 = (((((!((map__28226 == null))))?(((((map__28226.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28226.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28226):map__28226);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28226__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28226__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28226__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28222_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28222_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
