...
var G__28246 = cljs.core.next(ssv);
var G__28247 = (this_ssv == null);
var G__28248 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28249 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28246;
doing_nil_QMARK_ = G__28247;
last_elide = G__28248;
out = G__28249;
continue;
}
...
var G__28250 = cljs.core.next(remaining_cvec);
var G__28251 = new_idx;
var G__28252 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28250;
idx = G__28251;
out = G__28252;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__28187,cursor_vec){
var vec__28188 = p__28187;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28188,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28188,(1),null);
var focus_vec = vec__28188;
...
var vec__28191 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28191,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28191,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__28199){
var vec__28200 = p__28199;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28200,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28200,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28208,existing_count){
var vec__28209 = p__28208;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28209,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28209,(1),null);
...
return cljs.core.filterv((function (p1__28204_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28204_SHARP_))));
...
var vec__28219 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28219,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28219,(1),null);
var cvec_element = vec__28219;
...
var G__28270 = (idx + (1));
var G__28271 = idx;
var G__28272 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28269;
idx = G__28270;
start = G__28271;
out = G__28272;
...
var G__28274 = (idx + (1));
var G__28275 = (idx + (1));
var G__28276 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28273;
idx = G__28274;
start = G__28275;
out = G__28276;
...
var G__28282 = cljs.core.next(cvec_nl);
var G__28283 = (idx + (1));
var G__28284 = start;
var G__28285 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28282;
idx = G__28283;
start = G__28284;
out = G__28285;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28224_SHARP_,p2__28223_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28223_SHARP_)){
return cljs.core.reduced(p1__28224_SHARP_);
} else {
return (p1__28224_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28226,p__28227){
var vec__28228 = p__28226;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28228,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28228,(1),null);
var vec__28231 = p__28227;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28231,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28231,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28237,cvec,focus_vec){
var map__28238 = p__28237;
var map__28238__$1 = (((((!((map__28238 == null))))?(((((map__28238.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28238.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28238):map__28238);
var options = map__28238__$1;
var map__28239 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28238__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28239__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28239__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28239__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28235_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28235_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
