...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__28148_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28148_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__28148_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__28150){
var vec__28151 = p__28150;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28151,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28151,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__28159,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28162__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28162__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28162__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__28166 = (function (){var or__4126__auto__ = color;
...
var fexpr__28165 = (function (){var G__28167 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__28167) : style_map.call(null,G__28167));
})();
return (fexpr__28165.cljs$core$IFn$_invoke$arity$1 ? fexpr__28165.cljs$core$IFn$_invoke$arity$1(G__28166) : fexpr__28165.call(null,G__28166));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__28168){
var vec__28169 = p__28168;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28169,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28169,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28169,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__28172){
var vec__28173 = p__28172;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28173,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28173,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28173,(2),null);
...
var G__28233 = cljs.core.next(ssv);
var G__28234 = (this_ssv == null);
var G__28235 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28236 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28233;
doing_nil_QMARK_ = G__28234;
last_elide = G__28235;
out = G__28236;
continue;
}
...
var vec__28179 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28179,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28179,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28179,(2),null);
...
var G__28238 = cljs.core.next(remaining_cvec);
var G__28239 = new_idx;
var G__28240 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28238;
idx = G__28239;
out = G__28240;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__28186,cursor_vec){
var vec__28187 = p__28186;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28187,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28187,(1),null);
var focus_vec = vec__28187;
...
var vec__28190 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28190,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28190,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__28193){
var vec__28194 = p__28193;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28194,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28194,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28200,existing_count){
var vec__28201 = p__28200;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28201,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28201,(1),null);
...
return cljs.core.filterv((function (p1__28197_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28197_SHARP_))));
...
var vec__28207 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28207,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28207,(1),null);
var cvec_element = vec__28207;
if((cvec_element == null)){
var G__28252 = cljs.core.next(cvec_nl);
var G__28253 = (idx + (1));
var G__28254 = start;
var G__28255 = out;
cvec_nl = G__28252;
...
var G__28256 = cljs.core.next(cvec_nl);
var G__28257 = (idx + (1));
var G__28258 = idx;
var G__28259 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28256;
idx = G__28257;
start = G__28258;
out = G__28259;
...
var G__28260 = cljs.core.next(cvec_nl);
var G__28261 = (idx + (1));
var G__28262 = (idx + (1));
var G__28263 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28260;
idx = G__28261;
start = G__28262;
out = G__28263;
...
var G__28265 = cljs.core.next(cvec_nl);
var G__28266 = (idx + (1));
var G__28267 = idx;
var G__28268 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28265;
idx = G__28266;
start = G__28267;
out = G__28268;
...
var G__28269 = cljs.core.next(cvec_nl);
var G__28270 = (idx + (1));
var G__28271 = start;
var G__28272 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28269;
idx = G__28270;
start = G__28271;
out = G__28272;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28211_SHARP_,p2__28210_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28210_SHARP_)){
return cljs.core.reduced(p1__28211_SHARP_);
} else {
return (p1__28211_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28212,p__28213){
var vec__28214 = p__28212;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28214,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28214,(1),null);
var vec__28217 = p__28213;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28217,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28217,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28222,cvec,focus_vec){
...
var options = map__28223__$1;
var map__28224 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28223__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28224__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28224__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28224__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28221_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28221_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
