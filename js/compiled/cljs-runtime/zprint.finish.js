...
var G__28243 = cljs.core.next(ssv);
var G__28244 = (this_ssv == null);
var G__28245 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28246 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28243;
doing_nil_QMARK_ = G__28244;
last_elide = G__28245;
out = G__28246;
continue;
}
...
var G__28248 = cljs.core.next(remaining_cvec);
var G__28249 = new_idx;
var G__28250 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28248;
idx = G__28249;
out = G__28250;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__28188,cursor_vec){
var vec__28189 = p__28188;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28189,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28189,(1),null);
var focus_vec = vec__28189;
...
var vec__28192 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28192,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28192,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__28195){
var vec__28196 = p__28195;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28205,existing_count){
var vec__28207 = p__28205;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28207,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28207,(1),null);
...
return cljs.core.filterv((function (p1__28200_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28200_SHARP_))));
...
var vec__28216 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28216,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28216,(1),null);
var cvec_element = vec__28216;
if((cvec_element == null)){
var G__28264 = cljs.core.next(cvec_nl);
var G__28265 = (idx + (1));
var G__28266 = start;
var G__28267 = out;
cvec_nl = G__28264;
...
var G__28268 = cljs.core.next(cvec_nl);
var G__28269 = (idx + (1));
var G__28270 = idx;
var G__28271 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28268;
idx = G__28269;
start = G__28270;
out = G__28271;
...
var G__28272 = cljs.core.next(cvec_nl);
var G__28273 = (idx + (1));
var G__28274 = (idx + (1));
var G__28275 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28272;
idx = G__28273;
start = G__28274;
out = G__28275;
...
var G__28277 = cljs.core.next(cvec_nl);
var G__28278 = (idx + (1));
var G__28279 = idx;
var G__28280 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28277;
idx = G__28278;
start = G__28279;
out = G__28280;
...
var G__28281 = cljs.core.next(cvec_nl);
var G__28282 = (idx + (1));
var G__28283 = start;
var G__28284 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28281;
idx = G__28282;
start = G__28283;
out = G__28284;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28221_SHARP_,p2__28220_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28220_SHARP_)){
return cljs.core.reduced(p1__28221_SHARP_);
} else {
return (p1__28221_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28222,p__28223){
var vec__28224 = p__28222;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28224,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28224,(1),null);
var vec__28227 = p__28223;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28227,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28227,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28233,cvec,focus_vec){
...
var options = map__28234__$1;
var map__28235 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28235__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28235__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28235__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28232_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28232_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
