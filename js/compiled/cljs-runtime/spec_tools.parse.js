...
var fexpr__58187 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__58187.cljs$core$IFn$_invoke$arity$1 ? fexpr__58187.cljs$core$IFn$_invoke$arity$1(type) : fexpr__58187.call(null,type));
});
...
var G__58215 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__58215;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__58188 = spec_tools.impl.normalize_symbol(x);
var G__58189 = null;
...
var G__58190 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__58191 = x;
...
var G__58216 = cljs.spec.alpha.form(x);
x = G__58216;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__58192 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__58193 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__58192,G__58193) : spec_tools.parse.parse_form.call(null,G__58192,G__58193));
} else {
...
var G__58194 = parse_data;
var G__58194__$1 = (((G__58194 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__58194));
var G__58194__$2 = (((G__58194__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__58194__$1));
var G__58194__$3 = (((G__58194__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__58194__$2));
var G__58194__$4 = (((G__58194__$3 == null))?null:cljs.core.seq(G__58194__$3));
if((G__58194__$4 == null)){
return null;
} else {
return cljs.core.set(G__58194__$4);
}
}
});
...
var map__58200 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58200__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58200__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58200__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58200__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58200__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__58202 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__58202__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58202,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__58202);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58202__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__58202__$1;
}
}));
...
var map__58205 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58205__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__58207){
var vec__58208 = p__58207;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58208,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58208,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58208,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__58211){
...
var ___$1 = first__58214;
var values = seq__58213__$1;
