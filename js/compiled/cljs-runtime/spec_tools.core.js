...
var G__59095 = cljs.spec.alpha.get_spec(x);
x = G__59095;
continue;
} else {
...
var G__59096 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__59096;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__59136 = cljs.spec.alpha.get_spec(x);
x = G__59136;
continue;
} else {
