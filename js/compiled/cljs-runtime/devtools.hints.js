...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20777__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20777__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20777__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20776){var _e = e20776;
return false;
}});
...
var seen_errors_20820 = temp__5733__auto___20818;
if(cljs.core.truth_(seen_errors_20820.has(self))){
} else {
seen_errors_20820.add(self);

var temp__5735__auto___20821 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20821)){
var sense_20826 = temp__5735__auto___20821;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20826)].join(''));
} else {
}
}
} else {
