...
var map__20686 = top_item;
var map__20686__$1 = (((((!((map__20686 == null))))?(((((map__20686.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20686.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20686):map__20686);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20686__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20686__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20686__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20685){var _e = e20685;
return false;
}});
...
var seen_errors_20711 = temp__5733__auto___20708;
if(cljs.core.truth_(seen_errors_20711.has(self))){
} else {
seen_errors_20711.add(self);

var temp__5735__auto___20712 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20712)){
var sense_20714 = temp__5735__auto___20712;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20714)].join(''));
} else {
}
}
} else {
