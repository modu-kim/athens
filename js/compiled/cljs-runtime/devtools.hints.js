...
var seen_errors_20789 = temp__5733__auto___20787;
if(cljs.core.truth_(seen_errors_20789.has(self))){
} else {
seen_errors_20789.add(self);

var temp__5735__auto___20790 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20790)){
var sense_20792 = temp__5735__auto___20790;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20792)].join(''));
} else {
}
}
} else {
