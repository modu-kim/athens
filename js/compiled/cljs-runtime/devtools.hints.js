...
var map__20859 = top_item;
var map__20859__$1 = (((((!((map__20859 == null))))?(((((map__20859.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20859.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20859):map__20859);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20859__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20859__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20859__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20856){var _e = e20856;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20898 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20898)){
var seen_errors_20899 = temp__5733__auto___20898;
if(cljs.core.truth_(seen_errors_20899.has(self))){
} else {
seen_errors_20899.add(self);

var temp__5735__auto___20900 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20900)){
var sense_20903 = temp__5735__auto___20900;
