...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__46597 = (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"tag","tag",-1290361223)) : parser.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__46597) : tag_set.call(null,G__46597));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__46599){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46600__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46600__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__46604,hidden_QMARK_){
...
var p = map__46605__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46605__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__46607 = tag;
var G__46607__$1 = (((G__46607 instanceof cljs.core.Keyword))?G__46607.fqn:null);
switch (G__46607__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__46608_46632 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46609_46633 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46610_46634 = true;
var _STAR_print_fn_STAR__temp_val__46611_46635 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46610_46634);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46611_46635);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46609_46633);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46608_46632);
}
...
case "string-ci":
var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__46612_46636 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46613_46637 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46614_46638 = true;
var _STAR_print_fn_STAR__temp_val__46615_46639 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46614_46638);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46615_46639);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46613_46637);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46612_46636);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46607__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__46616){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46617__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46617__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4529__auto__ = (function instaparse$print$Parser__GT_str_$_iter__46619(s__46620){
return (new cljs.core.LazySeq(null,(function (){
var s__46620__$1 = s__46620;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46620__$1);
if(temp__5735__auto__){
var s__46620__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46620__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__46620__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__46622 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__46621 = (0);
while(true){
if((i__46621 < size__4528__auto__)){
var vec__46623 = cljs.core._nth(c__4527__auto__,i__46621);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46623,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46623,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__46622,instaparse.print.rule__GT_str(non_terminal,parser));

var G__46643 = (i__46621 + (1));
i__46621 = G__46643;
continue;
} else {
var G__46644 = (i__46621 + (1));
i__46621 = G__46644;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46622),instaparse$print$Parser__GT_str_$_iter__46619(cljs.core.chunk_rest(s__46620__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46622),null);
}
} else {
var vec__46626 = cljs.core.first(s__46620__$2);
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__46619(cljs.core.rest(s__46620__$2)));
} else {
var G__46645 = cljs.core.rest(s__46620__$2);
s__46620__$1 = G__46645;
continue;
}
}
} else {
