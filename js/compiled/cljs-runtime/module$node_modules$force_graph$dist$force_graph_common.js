...
state.linkHoverPrecision});var t=d3Zoom.zoomTransform(state.canvas);state.shadowGraph.globalScale(t.k).tickFrame()},800);(this._animationCycle=function animate(){if(state.enablePointerInteraction){var obj=null;if(!state.isPointerDragging){var pxScale=window.devicePixelRatio;(pxScale=0<JSCompiler_object_inline_x_1576&&0<JSCompiler_object_inline_y_1577?shadowCtx.getImageData(JSCompiler_object_inline_x_1576*pxScale,JSCompiler_object_inline_y_1577*pxScale,1,1):null)&&(obj=state.colorTracker.lookup(pxScale.data))}if(obj!==
