...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__27976){
var map__27977 = p__27976;
var map__27977__$1 = (((((!((map__27977 == null))))?(((((map__27977.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27977.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27977):map__27977);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27977__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27977__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27977__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27977__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27977__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__28000){
var vec__28001 = p__28000;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28001,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28001,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27999_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__27999_SHARP_,/:/);
...
var previous_config__27955__auto__ = devtools.prefs.get_prefs();
var prefs__27956__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__27956__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__27956__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__27956__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__27955__auto__);
}}));
...
var i__4737__auto___28047 = (0);
while(true){
if((i__4737__auto___28047 < len__4736__auto___28046)){
args__4742__auto__.push((arguments[i__4737__auto___28047]));

var G__28048 = (i__4737__auto___28047 + (1));
i__4737__auto___28047 = G__28048;
continue;
} else {
}
break;
