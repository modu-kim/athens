...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__62535,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__62536__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62536__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62536__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62536__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62536__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__62555 = cljs.core.next(args__$1);
var G__62556 = cljs.core.next(params__$1);
var G__62557 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__62555;
params__$1 = G__62556;
ret = G__62557;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__62538 = ctx__$1;
var G__62539 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__62538,G__62539) : interpret.call(null,G__62538,G__62539));
...
var vec__62540 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62540,(0),null);
var vec__62543 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62540,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62543,(0),null);
var G__62560 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__62560;
continue;
} else {
var G__62561 = recur_val;
args = G__62561;
continue;
}
} else {
...
var G__62562__i = 0, G__62562__a = new Array(arguments.length -  0);
while (G__62562__i < G__62562__a.length) {G__62562__a[G__62562__i] = arguments[G__62562__i + 0]; ++G__62562__i;}
  args = new cljs.core.IndexedSeq(G__62562__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__62563){
var args = cljs.core.seq(arglist__62563);
...
var map__62546 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__62550){
...
var f = map__62551__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62551__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62551__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__62568__delegate = function (args){
...
while (G__62569__i < G__62569__a.length) {G__62569__a[G__62569__i] = arguments[G__62569__i + 0]; ++G__62569__i;}
  args = new cljs.core.IndexedSeq(G__62569__a,0,null);
} 
return G__62568__delegate.call(this,args);};
G__62568.cljs$lang$maxFixedArity = 0;
G__62568.cljs$lang$applyTo = (function (arglist__62570){
var args = cljs.core.seq(arglist__62570);
return G__62568__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62548_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__62548_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__62571__delegate = function (args){
...
while (G__62572__i < G__62572__a.length) {G__62572__a[G__62572__i] = arguments[G__62572__i + 0]; ++G__62572__i;}
  args = new cljs.core.IndexedSeq(G__62572__a,0,null);
} 
return G__62571__delegate.call(this,args);};
G__62571.cljs$lang$maxFixedArity = 0;
G__62571.cljs$lang$applyTo = (function (arglist__62573){
var args = cljs.core.seq(arglist__62573);
return G__62571__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__62549_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__62549_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
