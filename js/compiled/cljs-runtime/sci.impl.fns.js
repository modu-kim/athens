...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__62600,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__62601 = p__62600;
var map__62601__$1 = (((((!((map__62601 == null))))?(((((map__62601.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62601.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62601):map__62601);
var _m = map__62601__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62601__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62601__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62601__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62601__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__62618 = cljs.core.next(args__$1);
var G__62619 = cljs.core.next(params__$1);
var G__62620 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__62618;
params__$1 = G__62619;
ret = G__62620;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__62603 = ctx__$1;
var G__62604 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__62603,G__62604) : interpret.call(null,G__62603,G__62604));
...
var vec__62605 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62605,(0),null);
var vec__62608 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62605,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62608,(0),null);
var G__62621 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__62621;
continue;
} else {
var G__62622 = recur_val;
args = G__62622;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__62624){
...
var map__62611 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62611__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62611__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__62615){
...
var f = map__62616__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62616__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62616__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__62625__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__62625 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62626__i = 0, G__62626__a = new Array(arguments.length -  0);
while (G__62626__i < G__62626__a.length) {G__62626__a[G__62626__i] = arguments[G__62626__i + 0]; ++G__62626__i;}
  args = new cljs.core.IndexedSeq(G__62626__a,0,null);
} 
return G__62625__delegate.call(this,args);};
G__62625.cljs$lang$maxFixedArity = 0;
G__62625.cljs$lang$applyTo = (function (arglist__62627){
var args = cljs.core.seq(arglist__62627);
return G__62625__delegate(args);
});
G__62625.cljs$core$IFn$_invoke$arity$variadic = G__62625__delegate;
return G__62625;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62613_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__62613_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__62628__delegate = function (args){
...
var G__62628 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62629__i = 0, G__62629__a = new Array(arguments.length -  0);
while (G__62629__i < G__62629__a.length) {G__62629__a[G__62629__i] = arguments[G__62629__i + 0]; ++G__62629__i;}
  args = new cljs.core.IndexedSeq(G__62629__a,0,null);
} 
return G__62628__delegate.call(this,args);};
G__62628.cljs$lang$maxFixedArity = 0;
G__62628.cljs$lang$applyTo = (function (arglist__62630){
var args = cljs.core.seq(arglist__62630);
return G__62628__delegate(args);
});
G__62628.cljs$core$IFn$_invoke$arity$variadic = G__62628__delegate;
return G__62628;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__62614_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__62614_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
