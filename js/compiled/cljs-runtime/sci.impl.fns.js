...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__62608,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__62609 = p__62608;
...
var _m = map__62609__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62609__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62609__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62609__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62609__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__62626 = cljs.core.next(args__$1);
var G__62627 = cljs.core.next(params__$1);
var G__62628 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__62626;
params__$1 = G__62627;
ret = G__62628;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__62611 = ctx__$1;
var G__62612 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__62611,G__62612) : interpret.call(null,G__62611,G__62612));
...
var vec__62613 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62613,(0),null);
var vec__62616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62613,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62616,(0),null);
var G__62629 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__62629;
continue;
} else {
var G__62630 = recur_val;
args = G__62630;
continue;
}
} else {
...
var G__62631__i = 0, G__62631__a = new Array(arguments.length -  0);
while (G__62631__i < G__62631__a.length) {G__62631__a[G__62631__i] = arguments[G__62631__i + 0]; ++G__62631__i;}
  args = new cljs.core.IndexedSeq(G__62631__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__62632){
var args = cljs.core.seq(arglist__62632);
...
var map__62619 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62619__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62619__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__62623){
...
var f = map__62624__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62624__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62624__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__62633__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__62633 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62634__i = 0, G__62634__a = new Array(arguments.length -  0);
while (G__62634__i < G__62634__a.length) {G__62634__a[G__62634__i] = arguments[G__62634__i + 0]; ++G__62634__i;}
  args = new cljs.core.IndexedSeq(G__62634__a,0,null);
} 
return G__62633__delegate.call(this,args);};
G__62633.cljs$lang$maxFixedArity = 0;
G__62633.cljs$lang$applyTo = (function (arglist__62635){
var args = cljs.core.seq(arglist__62635);
return G__62633__delegate(args);
});
G__62633.cljs$core$IFn$_invoke$arity$variadic = G__62633__delegate;
return G__62633;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62621_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__62621_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__62636__delegate = function (args){
...
var G__62636 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62637__i = 0, G__62637__a = new Array(arguments.length -  0);
while (G__62637__i < G__62637__a.length) {G__62637__a[G__62637__i] = arguments[G__62637__i + 0]; ++G__62637__i;}
  args = new cljs.core.IndexedSeq(G__62637__a,0,null);
} 
return G__62636__delegate.call(this,args);};
G__62636.cljs$lang$maxFixedArity = 0;
G__62636.cljs$lang$applyTo = (function (arglist__62638){
var args = cljs.core.seq(arglist__62638);
return G__62636__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__62622_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__62622_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
