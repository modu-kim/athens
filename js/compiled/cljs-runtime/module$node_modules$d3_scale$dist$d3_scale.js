...
function(_){if(!arguments.length)return domain.slice();domain=[];index=new Map;for(var $jscomp$iter$49=$jscomp.makeIterator(_),$jscomp$key$value=$jscomp$iter$49.next();!$jscomp$key$value.done;$jscomp$key$value=$jscomp$iter$49.next()){$jscomp$key$value=$jscomp$key$value.value;var key=$jscomp$key$value+"";index.has(key)||index.set(key,domain.push($jscomp$key$value))}return scale};scale.range=function(_){return arguments.length?(range=Array.from(_),scale):range.slice()};scale.unknown=function(_){return arguments.length?
...
delete scale.paddingOuter;scale.copy=function(){return pointish(copy())};return scale}function constants(x){return function(){return x}}function number(x){return+x}function identity(x){return x}function normalize(a,b){return(b-=a=+a)?function(x){return(x-a)/b}:constants(isNaN(b)?NaN:.5)}function clamper(a,b){if(a>b){var t=a;a=b;b=t}return function(x){return Math.max(a,Math.min(b,x))}}function bimap(domain,range,interpolate){var d0=domain[0];domain=domain[1];var r0=range[0];range=range[1];domain<d0?
...
day(date)<date?formatHour:month(date)<date?week(date)<date?formatDay:formatWeek:year(date)<date?formatMonth:formatYear)(date)}function tickInterval(interval,start,stop){null==interval&&(interval=10);if("number"===typeof interval){var target=Math.abs(stop-start)/interval,i$jscomp$0=d3Array.bisector(function(i){return i[2]}).right(tickIntervals,target);i$jscomp$0===tickIntervals.length?(start=d3Array.tickStep(start/durationYear,stop/durationYear,interval),interval=year):i$jscomp$0?(i$jscomp$0=tickIntervals[target/
...
function divergingPow(){var scale=powish(transformer$2());scale.copy=function(){return copy$1(scale,divergingPow()).exponent(scale.exponent())};return initInterpolator.apply(scale,arguments)}var implicit=Symbol("implicit"),unit=[0,1],durationWeek=6048E5,durationMonth=2592E6,durationYear=31536E6;exports.scaleBand=band;exports.scaleDiverging=diverging;exports.scaleDivergingLog=divergingLog;exports.scaleDivergingPow=divergingPow;exports.scaleDivergingSqrt=function(){return divergingPow.apply(null,arguments).exponent(.5)};
exports.scaleDivergingSymlog=divergingSymlog;exports.scaleIdentity=identity$1;exports.scaleImplicit=implicit;exports.scaleLinear=linear;exports.scaleLog=log;exports.scaleOrdinal=ordinal;exports.scalePoint=function(){return pointish(band.apply(null,arguments).paddingInner(1))};exports.scalePow=pow;exports.scaleQuantile=quantile;exports.scaleQuantize=quantize;exports.scaleRadial=radial;exports.scaleSequential=sequential;exports.scaleSequentialLog=sequentialLog;exports.scaleSequentialPow=sequentialPow;
exports.scaleSequentialQuantile=sequentialQuantile;exports.scaleSequentialSqrt=function(){return sequentialPow.apply(null,arguments).exponent(.5)};exports.scaleSequentialSymlog=sequentialSymlog;exports.scaleSqrt=function(){return pow.apply(null,arguments).exponent(.5)};exports.scaleSymlog=symlog;exports.scaleThreshold=threshold;exports.scaleTime=function(){return initRange.apply(calendar(d3Time.timeYear,d3Time.timeMonth,d3Time.timeWeek,d3Time.timeDay,d3Time.timeHour,d3Time.timeMinute,d3Time.timeSecond,
