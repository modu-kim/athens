...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62593 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62593(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62590 = (n - (1));
var G__62591 = cljs.core.rest(s);
var G__62592 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62590,G__62591,G__62592) : sci.impl.max_or_throw.take_STAR_.call(null,G__62590,G__62591,G__62592));
})());
} else {
return null;
}
