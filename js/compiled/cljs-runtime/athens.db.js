...
return athens.db.sort_block_children(cljs.core.deref(posh.reagent.pull(athens.db.dsdb,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46498_SHARP_){
return (!(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__46498_SHARP_,new cljs.core.Keyword("db","id","db/id",-1388397098))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__46498_SHARP_,new cljs.core.Keyword("block","_refs","block/_refs",830218531))))));
...
return athens.db.get_block(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__46499 = cljs.core.deref(athens.db.dsdb);
var G__46500 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__46499,G__46500) : datascript.core.entity.call(null,G__46499,G__46500));
})()))));
});
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46529_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__46529_SHARP_,new cljs.core.Keyword("block","_children","block/_children",1128070632));
...
var G__46597 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(parent);
uid__$1 = G__46597;
continue;
}
break;
...
var G__46603 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__46604 = cljs.core.next(xs__$1);
acc = G__46603;
xs__$1 = G__46604;
continue;
...
}),(function (){var G__46562 = cljs.core.deref(athens.db.dsdb);
var G__46563 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","string","block/string",-2066596447)], null);
var G__46564 = athens.db.get_ref_ids(pattern);
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__46562,G__46563,G__46564) : datascript.core.pull_many.call(null,G__46562,G__46563,G__46564));
})());
});
...
var map__46572 = cljs.core.deref(state);
...
var local = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46572__$1,new cljs.core.Keyword("string","local","string/local",-578009907));
var previous = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46572__$1,new cljs.core.Keyword("string","previous","string/previous",1734905219));
