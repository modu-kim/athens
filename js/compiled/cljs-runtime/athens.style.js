...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__61208){
var vec__61209 = p__61208;
var color_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61209,(0),null);
var color_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61209,(1),null);
...
var permute_light_61233 = athens.style.permute_color_opacities(athens.style.THEME_LIGHT);
var permute_dark_61234 = athens.style.permute_color_opacities(athens.style.THEME_DARK);
stylefy.core.tag(":root",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([permute_light_61233,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834),cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"prefers-color-scheme","prefers-color-scheme",-1885369990),"dark"], null),permute_dark_61234])], null)], 0)));
