...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__61207){
var vec__61208 = p__61207;
var color_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61208,(0),null);
var color_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61208,(1),null);
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(["--",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(color_k))].join('')),color_v], null),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__61212){
var vec__61213 = p__61212;
var opacity_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61213,(0),null);
var opacity_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61213,(1),null);
...
var permute_light_61229 = athens.style.permute_color_opacities(athens.style.THEME_LIGHT);
var permute_dark_61230 = athens.style.permute_color_opacities(athens.style.THEME_DARK);
stylefy.core.tag(":root",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([permute_light_61229,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834),cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"prefers-color-scheme","prefers-color-scheme",-1885369990),"dark"], null),permute_dark_61230])], null)], 0)));
