...
var opacity_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61226,(1),null);
...
var permute_light_61238 = athens.style.permute_color_opacities(athens.style.THEME_LIGHT);
var permute_dark_61239 = athens.style.permute_color_opacities(athens.style.THEME_DARK);
stylefy.core.tag(":root",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([permute_light_61238,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834),cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"prefers-color-scheme","prefers-color-scheme",-1885369990),"dark"], null),permute_dark_61239])], null)], 0)));
