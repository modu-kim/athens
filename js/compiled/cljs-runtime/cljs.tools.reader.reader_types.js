...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24245 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24245(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24246 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24246(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24251 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24251(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24252 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24252(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24255 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24255(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24256 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24256(reader);
}
});
...
var G__24294 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24295 = s.append(c);
c = G__24294;
s = G__24295;
continue;
}
