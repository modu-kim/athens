...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24239 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24239(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24242 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24242(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24244 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24244(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24248 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24248(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24250 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24250(reader);
}
});
