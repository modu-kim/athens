...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29568,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29568,else__4383__auto__);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29567){
var self__ = this;
var G__29567__$1 = this;
return (new cljs.core.RecordIter((0),G__29567__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29569,other29570){
var self__ = this;
var this29569__$1 = this;
return (((!((other29570 == null)))) && ((this29569__$1.constructor === other29570.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.tag,other29570.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.wrap_fn,other29570.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.wrap_length,other29570.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.seq_fn,other29570.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.children,other29570.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29569__$1.__extmap,other29570.__extmap)));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29567){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29587 = cljs.core.keyword_identical_QMARK_;
var expr__29588 = k__4388__auto__;
if(cljs.core.truth_((pred__29587.cljs$core$IFn$_invoke$arity$2 ? pred__29587.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29588) : pred__29587.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29588)))){
return (new rewrite_clj.node.seq.SeqNode(G__29567,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29587.cljs$core$IFn$_invoke$arity$2 ? pred__29587.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29588) : pred__29587.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29588)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__29567,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29587.cljs$core$IFn$_invoke$arity$2 ? pred__29587.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29588) : pred__29587.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29588)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__29567,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29587.cljs$core$IFn$_invoke$arity$2 ? pred__29587.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29588) : pred__29587.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29588)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__29567,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29587.cljs$core$IFn$_invoke$arity$2 ? pred__29587.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__29588) : pred__29587.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__29588)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__29567,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29567),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29567){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__29567,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__29571){
var extmap__4419__auto__ = (function (){var G__29594 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29571,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29571)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29594);
} else {
return G__29594;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29571),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__29571),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__29571),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__29571),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29571),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
