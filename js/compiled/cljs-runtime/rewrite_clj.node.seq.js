...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29562,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29573){
var vec__29574 = p__29573;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29574,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29574,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29563,other29564){
var self__ = this;
var this29563__$1 = this;
return (((!((other29564 == null)))) && ((this29563__$1.constructor === other29564.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.tag,other29564.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.wrap_fn,other29564.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.wrap_length,other29564.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.seq_fn,other29564.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.children,other29564.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29563__$1.__extmap,other29564.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__29582 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__29582) : self__.wrap_fn.call(null,G__29582));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29561){
var self__ = this;
...
return (new rewrite_clj.node.seq.SeqNode(G__29561,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__29561,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__29561,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__29561,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__29561,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29561),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29561){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__29561,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__29569){
var extmap__4419__auto__ = (function (){var G__29590 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29569,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29569),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__29569),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__29569),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__29569),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29569),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__29592_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__29592_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__29595_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__29595_SHARP_);
}),children);
});
