...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29543,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29543,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29548){
var vec__29549 = p__29548;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29549,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29542){
var self__ = this;
var G__29542__$1 = this;
return (new cljs.core.RecordIter((0),G__29542__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29544,other29545){
var self__ = this;
var this29544__$1 = this;
return (((!((other29545 == null)))) && ((this29544__$1.constructor === other29545.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.tag,other29545.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.wrap_fn,other29545.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.wrap_length,other29545.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.seq_fn,other29545.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.children,other29545.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29544__$1.__extmap,other29545.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__29556 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__29556) : self__.seq_fn.call(null,G__29556));
}));
...
var self__ = this;
var this$__$1 = this;
var G__29557 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__29557) : self__.wrap_fn.call(null,G__29557));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29542){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29558 = cljs.core.keyword_identical_QMARK_;
var expr__29559 = k__4388__auto__;
if(cljs.core.truth_((pred__29558.cljs$core$IFn$_invoke$arity$2 ? pred__29558.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29559) : pred__29558.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29559)))){
return (new rewrite_clj.node.seq.SeqNode(G__29542,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29558.cljs$core$IFn$_invoke$arity$2 ? pred__29558.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29559) : pred__29558.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29559)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__29542,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29558.cljs$core$IFn$_invoke$arity$2 ? pred__29558.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29559) : pred__29558.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29559)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__29542,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29558.cljs$core$IFn$_invoke$arity$2 ? pred__29558.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29559) : pred__29558.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29559)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__29542,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29558.cljs$core$IFn$_invoke$arity$2 ? pred__29558.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__29559) : pred__29558.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__29559)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__29542,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29542),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29542){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__29542,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__29546){
var extmap__4419__auto__ = (function (){var G__29568 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29546,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29546)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29568);
} else {
return G__29568;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29546),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__29546),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__29546),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__29546),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29546),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__29569_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__29569_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__29574_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__29574_SHARP_);
}),children);
});
