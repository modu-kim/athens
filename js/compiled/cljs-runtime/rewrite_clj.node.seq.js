...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29575,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__29580 = k29575;
var G__29580__$1 = (((G__29580 instanceof cljs.core.Keyword))?G__29580.fqn:null);
switch (G__29580__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29575,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29582){
var vec__29583 = p__29582;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29574){
var self__ = this;
var G__29574__$1 = this;
return (new cljs.core.RecordIter((0),G__29574__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29576,other29577){
var self__ = this;
var this29576__$1 = this;
return (((!((other29577 == null)))) && ((this29576__$1.constructor === other29577.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.tag,other29577.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.wrap_fn,other29577.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.wrap_length,other29577.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.seq_fn,other29577.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.children,other29577.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29576__$1.__extmap,other29577.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__29590 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__29590) : self__.seq_fn.call(null,G__29590));
}));
...
var self__ = this;
var this$__$1 = this;
var G__29591 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__29591) : self__.wrap_fn.call(null,G__29591));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29574){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29592 = cljs.core.keyword_identical_QMARK_;
var expr__29593 = k__4388__auto__;
if(cljs.core.truth_((pred__29592.cljs$core$IFn$_invoke$arity$2 ? pred__29592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29593) : pred__29592.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__29593)))){
return (new rewrite_clj.node.seq.SeqNode(G__29574,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29592.cljs$core$IFn$_invoke$arity$2 ? pred__29592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29593) : pred__29592.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__29593)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__29574,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29592.cljs$core$IFn$_invoke$arity$2 ? pred__29592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29593) : pred__29592.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__29593)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__29574,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29592.cljs$core$IFn$_invoke$arity$2 ? pred__29592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29593) : pred__29592.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__29593)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__29574,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29592.cljs$core$IFn$_invoke$arity$2 ? pred__29592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__29593) : pred__29592.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__29593)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__29574,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29574),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29574){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__29574,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__29578){
var extmap__4419__auto__ = (function (){var G__29595 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29578,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29578)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29595);
} else {
return G__29595;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29578),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__29578),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__29578),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__29578),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29578),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__29596_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__29596_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__29597_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__29597_SHARP_);
}),children);
});
