...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__29822,k,f){
var vec__29823 = p__29822;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29823,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29823,(1),null);
var loc = vec__29823;
...
var G__29853 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__29853;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__29832){
var vec__29833 = p__29832;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29833,(0),null);
var map__29836 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29833,(1),null);
...
var path = map__29836__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29836__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__29833;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__29839){
var vec__29840 = p__29839;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29840,(0),null);
var map__29843 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29840,(1),null);
var map__29843__$1 = (((((!((map__29843 == null))))?(((((map__29843.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29843.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29843):map__29843);
var path = map__29843__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29843__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__29840;
if(cljs.core.seq(r)){
