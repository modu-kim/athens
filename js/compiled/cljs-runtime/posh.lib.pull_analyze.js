...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34158_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__34158_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__34158_SHARP_,refs_only_QMARK_));
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__34213,pull_pattern,ent_ids){
...
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34214__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34214__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_(retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34207_SHARP_){
var fexpr__34223 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__34223.cljs$core$IFn$_invoke$arity$2 ? fexpr__34223.cljs$core$IFn$_invoke$arity$2(db,p1__34207_SHARP_) : fexpr__34223.call(null,db,p1__34207_SHARP_));
}),ent_ids);
