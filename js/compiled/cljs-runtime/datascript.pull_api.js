...
var G__37831 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__37831__$1 = (((G__37831 == null))?null:cljs.core.persistent_BANG_(G__37831));
if((G__37831__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__37831__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__37832){
...
var frame = first__37835;
var frames = seq__37834__$1;
...
var results = (function (){var G__37836 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__37836,kvps);
} else {
return G__37836;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37837__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37837__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_37940 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_37940,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var vec__37852 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37852,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37852,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__37861){
var vec__37862 = p__37861;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37862,(0),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__37865){
...
var frame = first__37868;
var frames = seq__37867__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__37879){
...
var vec__37883 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37883,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37883,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37916__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37916__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__37921 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__37921,attr,eid);
} else {
return G__37921;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37923__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37923__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__37925){
while(true){
...
var frame = first__37928;
var frames = seq__37927__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__37967 = db;
var G__37968 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__37967;
p__37925 = G__37968;
continue;
}
...
while(true){
var G__37929 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__37929__$1 = (((G__37929 instanceof cljs.core.Keyword))?G__37929.fqn:null);
switch (G__37929__$1) {
case "expand":
var G__37970 = db;
var G__37971 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__37970;
frames = G__37971;
continue;
...
case "expand-rev":
var G__37972 = db;
var G__37973 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__37972;
frames = G__37973;
continue;
...
case "pattern":
var G__37974 = db;
var G__37975 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__37974;
frames = G__37975;
continue;
...
case "recursion":
var G__37976 = db;
var G__37977 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__37976;
frames = G__37977;
continue;
...
var f = first__37932;
var remaining = seq__37931__$1;
var result = (function (){var G__37933 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__37933);
} else {
return G__37933;
}
})();
...
var G__37978 = db;
var G__37979 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__37934 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37934,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__37934;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37929__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__37935_SHARP_){
return datascript.db.entid_strict(db,p1__37935_SHARP_);
})),eids);
