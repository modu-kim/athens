...
var pattern_37882 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_37882,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__37836){
...
var parent = first__37839;
var frames = seq__37838__$1;
...
var found = cljs.core.not_empty((function (){var G__37840 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__37840);
} else {
return G__37840;
}
})());
...
var as_value = (function (){var G__37841 = datom_val;
if(ref_QMARK_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__37842 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__37842);
} else {
return G__37842;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__37843 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37843,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__37843;
}
})());
...
var vec__37844 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37844,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37844,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__37847){
var vec__37848 = p__37847;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37848,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37848,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__37851){
...
var frame = first__37854;
var frames = seq__37853__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__37855){
...
var vec__37859 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37859,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37859,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37862__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37862__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__37864 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__37864,attr,eid);
} else {
return G__37864;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37865__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37865__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__37867){
while(true){
...
var frame = first__37870;
var frames = seq__37869__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__37897 = db;
var G__37898 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__37897;
p__37867 = G__37898;
continue;
}
...
while(true){
var G__37871 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__37871__$1 = (((G__37871 instanceof cljs.core.Keyword))?G__37871.fqn:null);
switch (G__37871__$1) {
case "expand":
var G__37900 = db;
var G__37901 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__37900;
frames = G__37901;
continue;
...
case "expand-rev":
var G__37902 = db;
var G__37903 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__37902;
frames = G__37903;
continue;
...
case "pattern":
var G__37907 = db;
var G__37908 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__37907;
frames = G__37908;
continue;
...
case "recursion":
var G__37909 = db;
var G__37910 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__37909;
frames = G__37910;
continue;
...
var f = first__37874;
var remaining = seq__37873__$1;
var result = (function (){var G__37875 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__37875);
} else {
return G__37875;
}
})();
...
var G__37914 = db;
var G__37915 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__37876 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37876,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__37876;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37871__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__37878_SHARP_){
return datascript.db.entid_strict(db,p1__37878_SHARP_);
})),eids);
