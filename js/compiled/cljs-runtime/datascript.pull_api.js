...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37825__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37825__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__37827 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__37827__$1 = (((G__37827 == null))?null:cljs.core.persistent_BANG_(G__37827));
if((G__37827__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__37827__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__37828){
...
var frame = first__37831;
var frames = seq__37830__$1;
...
var results = (function (){var G__37832 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__37832,kvps);
} else {
return G__37832;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37833__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37833__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_37936 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_37936,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__37840){
...
var parent = first__37843;
var frames = seq__37842__$1;
...
var found = cljs.core.not_empty((function (){var G__37844 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__37844);
} else {
return G__37844;
}
})());
...
var as_value = (function (){var G__37845 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__37839_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__37839_SHARP_]);
}),G__37845);
} else {
return G__37845;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__37846 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__37846);
} else {
return G__37846;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__37847 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37847,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__37847;
}
})());
...
var vec__37848 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37848,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37848,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__37851){
var vec__37852 = p__37851;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37852,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37852,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__37855){
...
var frame = first__37858;
var frames = seq__37857__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__37859){
...
var frame = first__37862;
var frames = seq__37861__$1;
...
var vec__37863 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37863,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37863,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37866__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37866__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__37868 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__37868,attr,eid);
} else {
return G__37868;
}
})();
...
var map__37875 = frame;
var map__37875__$1 = (((((!((map__37875 == null))))?(((((map__37875.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37875.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37875):map__37875);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37875__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37875__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__37881){
while(true){
...
var frame = first__37884;
var frames = seq__37883__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__37941 = db;
var G__37942 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__37941;
p__37881 = G__37942;
continue;
}
...
while(true){
var G__37889 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__37889__$1 = (((G__37889 instanceof cljs.core.Keyword))?G__37889.fqn:null);
switch (G__37889__$1) {
case "expand":
var G__37944 = db;
var G__37945 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__37944;
frames = G__37945;
continue;
...
case "expand-rev":
var G__37946 = db;
var G__37947 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__37946;
frames = G__37947;
continue;
...
case "pattern":
var G__37948 = db;
var G__37949 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__37948;
frames = G__37949;
continue;
...
case "recursion":
var G__37950 = db;
var G__37951 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__37950;
frames = G__37951;
continue;
...
var f = first__37892;
var remaining = seq__37891__$1;
var result = (function (){var G__37896 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__37896);
} else {
return G__37896;
}
})();
...
var G__37952 = db;
var G__37953 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__37897 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37897,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__37897;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37889__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__37901_SHARP_){
return datascript.db.entid_strict(db,p1__37901_SHARP_);
})),eids);
