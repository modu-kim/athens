...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26658__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__26658__delegate.call(this,args);};
G__26658.cljs$lang$maxFixedArity = 0;
G__26658.cljs$lang$applyTo = (function (arglist__26660){
var args = cljs.core.seq(arglist__26660);
return G__26658__delegate(args);
});
...
var temp__5739__auto___26687 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___26687 == null)){
} else {
var key_26692 = temp__5739__auto___26687;
(jsprops.key = key_26692);
}
