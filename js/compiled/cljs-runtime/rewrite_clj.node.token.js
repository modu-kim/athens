...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29599,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__29603 = k29599;
var G__29603__$1 = (((G__29603 instanceof cljs.core.Keyword))?G__29603.fqn:null);
switch (G__29603__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29599,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29605){
var vec__29606 = p__29605;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29606,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29606,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29600,other29601){
var self__ = this;
var this29600__$1 = this;
return (((!((other29601 == null)))) && ((this29600__$1.constructor === other29601.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29600__$1.value,other29601.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29600__$1.string_value,other29601.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29600__$1.__extmap,other29601.__extmap)));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29598){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29609 = cljs.core.keyword_identical_QMARK_;
var expr__29610 = k__4388__auto__;
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__29610) : pred__29609.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__29610)))){
return (new rewrite_clj.node.token.TokenNode(G__29598,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__29609.cljs$core$IFn$_invoke$arity$2 ? pred__29609.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__29610) : pred__29609.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__29610)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__29598,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29598),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29598){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__29598,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__29602){
var extmap__4419__auto__ = (function (){var G__29612 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29602,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__29602)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29612);
} else {
return G__29612;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__29602),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__29602),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
