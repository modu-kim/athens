...
var G__35592 = cljs.core.first(poshdb);
var G__35592__$1 = (((G__35592 instanceof cljs.core.Keyword))?G__35592.fqn:null);
switch (G__35592__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35592__$1)].join('')));
...
var G__35637 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__35637;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35602__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35602__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35602__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35602__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__35604 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35604.cljs$core$IFn$_invoke$arity$1 ? fexpr__35604.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__35604.call(null,conn));
}
})();
...
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__35607 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35607.cljs$core$IFn$_invoke$arity$2 ? fexpr__35607.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__35607.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__35613 = db__$4;
var G__35614 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__35612 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35612.cljs$core$IFn$_invoke$arity$2 ? fexpr__35612.cljs$core$IFn$_invoke$arity$2(G__35613,G__35614) : fexpr__35612.call(null,G__35613,G__35614));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__35619,poshdb){
...
var posh_tree = map__35620__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35620__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35620__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__35623 = (function (){var G__35625 = posh_tree;
var G__35626 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__35625,G__35626) : posh.lib.db.poshdb__GT_db.call(null,G__35625,G__35626));
})();
var G__35624 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__35622 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35622.cljs$core$IFn$_invoke$arity$2 ? fexpr__35622.cljs$core$IFn$_invoke$arity$2(G__35623,G__35624) : fexpr__35622.call(null,G__35623,G__35624));
}
});
