...
var G__35636 = cljs.core.cons(pdb,path);
var G__35637 = posh.lib.db.get_parent_db(pdb);
path = G__35636;
pdb = G__35637;
continue;
} else {
...
var map__35610 = filters;
var map__35610__$1 = (((((!((map__35610 == null))))?(((((map__35610.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35610.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__35610):map__35610);
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35610__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35610__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35610__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35610__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__35613 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35613.cljs$core$IFn$_invoke$arity$1 ? fexpr__35613.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__35613.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__35614 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35614.cljs$core$IFn$_invoke$arity$2 ? fexpr__35614.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__35614.call(null,db__$1,since));
})():db__$1);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__35621,poshdb){
...
var posh_tree = map__35622__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35622__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35622__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__35627 = (function (){var G__35630 = posh_tree;
var G__35631 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__35630,G__35631) : posh.lib.db.poshdb__GT_db.call(null,G__35630,G__35631));
})();
var G__35628 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__35626 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35626.cljs$core$IFn$_invoke$arity$2 ? fexpr__35626.cljs$core$IFn$_invoke$arity$2(G__35627,G__35628) : fexpr__35626.call(null,G__35627,G__35628));
}
});
