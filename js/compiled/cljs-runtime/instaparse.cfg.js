...
var G__47702 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__47702)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__47702)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__47702)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47702)].join('')));
...
var G__47751 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__47750;
v = G__47751;
continue;
} else {
var G__47752 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__47753 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__47752;
v = G__47753;
continue;
}
...
var G__47755 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__47754;
v = G__47755;
continue;
...
break;
default:
var G__47756 = cljs.core.next(sq);
var G__47757 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__47756;
v = G__47757;
continue;
...
while(true){
var G__47716 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__47716__$1 = (((G__47716 instanceof cljs.core.Keyword))?G__47716.fqn:null);
switch (G__47716__$1) {
case "rule":
var vec__47717 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47717,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47717,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__47720 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__47720) : instaparse.cfg.content.call(null,G__47720));
...
break;
case "paren":
var G__47760 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__47760;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__47721 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__47722 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__47723 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__47724 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__47725 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__47726 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47726) : instaparse.cfg.build_rule.call(null,G__47726));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47716__$1)].join('')));
...
while(true){
var G__47727 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__47762 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__47762;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47727__$1)].join('')));
...
var valid_nts_47763 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__47728_47764 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__47729_47765 = null;
var count__47730_47766 = (0);
var i__47731_47767 = (0);
while(true){
if((i__47731_47767 < count__47730_47766)){
var nt_47768 = chunk__47729_47765.cljs$core$IIndexed$_nth$arity$2(null,i__47731_47767);
if(cljs.core.truth_((valid_nts_47763.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47763.cljs$core$IFn$_invoke$arity$1(nt_47768) : valid_nts_47763.call(null,nt_47768)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_47768),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__47769 = seq__47728_47764;
var G__47770 = chunk__47729_47765;
var G__47771 = count__47730_47766;
var G__47772 = (i__47731_47767 + (1));
seq__47728_47764 = G__47769;
chunk__47729_47765 = G__47770;
count__47730_47766 = G__47771;
i__47731_47767 = G__47772;
continue;
} else {
var temp__5735__auto___47773 = cljs.core.seq(seq__47728_47764);
if(temp__5735__auto___47773){
var seq__47728_47774__$1 = temp__5735__auto___47773;
if(cljs.core.chunked_seq_QMARK_(seq__47728_47774__$1)){
var c__4556__auto___47775 = cljs.core.chunk_first(seq__47728_47774__$1);
var G__47776 = cljs.core.chunk_rest(seq__47728_47774__$1);
var G__47777 = c__4556__auto___47775;
var G__47778 = cljs.core.count(c__4556__auto___47775);
var G__47779 = (0);
seq__47728_47764 = G__47776;
chunk__47729_47765 = G__47777;
count__47730_47766 = G__47778;
i__47731_47767 = G__47779;
continue;
} else {
var nt_47780 = cljs.core.first(seq__47728_47774__$1);
if(cljs.core.truth_((valid_nts_47763.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47763.cljs$core$IFn$_invoke$arity$1(nt_47780) : valid_nts_47763.call(null,nt_47780)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_47780),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__47781 = cljs.core.next(seq__47728_47774__$1);
var G__47782 = null;
var G__47783 = (0);
var G__47784 = (0);
seq__47728_47764 = G__47781;
chunk__47729_47765 = G__47782;
count__47730_47766 = G__47783;
i__47731_47767 = G__47784;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__47732_47785 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47733_47786 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47734_47787 = true;
var _STAR_print_fn_STAR__temp_val__47735_47788 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47734_47787);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47735_47788);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47733_47786);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47732_47785);
}
...
var len__4736__auto___47805 = arguments.length;
var i__4737__auto___47806 = (0);
while(true){
if((i__4737__auto___47806 < len__4736__auto___47805)){
args__4742__auto__.push((arguments[i__4737__auto___47806]));

var G__47812 = (i__4737__auto___47806 + (1));
i__4737__auto___47806 = G__47812;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__47738){
...
var _STAR_case_insensitive_literals_STAR__orig_val__47741 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__47742 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__47742);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__47743_47821 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47744_47822 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47745_47823 = true;
var _STAR_print_fn_STAR__temp_val__47746_47824 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47745_47823);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47746_47824);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47744_47822);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47743_47821);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__47741);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq47736){
var G__47737 = cljs.core.first(seq47736);
var seq47736__$1 = cljs.core.next(seq47736);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47737,seq47736__$1);
}));
