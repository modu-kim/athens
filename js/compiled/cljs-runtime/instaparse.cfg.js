...
var G__47698 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__47698)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__47698)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__47698)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47698)].join('')));
...
var G__47745 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__47746 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__47745;
v = G__47746;
continue;
} else {
var G__47747 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__47748 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__47747;
v = G__47748;
continue;
}
...
break;
case "\"":
var G__47749 = cljs.core.next(sq);
var G__47750 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__47749;
v = G__47750;
continue;
...
break;
default:
var G__47751 = cljs.core.next(sq);
var G__47752 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__47751;
v = G__47752;
continue;
...
while(true){
var G__47708 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__47708__$1 = (((G__47708 instanceof cljs.core.Keyword))?G__47708.fqn:null);
switch (G__47708__$1) {
case "rule":
var vec__47709 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47709,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47709,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__47712 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__47712) : instaparse.cfg.content.call(null,G__47712));
...
break;
case "paren":
var G__47755 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__47755;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__47713 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47713) : instaparse.cfg.build_rule.call(null,G__47713));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__47714 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47714) : instaparse.cfg.build_rule.call(null,G__47714));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__47715 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47715) : instaparse.cfg.build_rule.call(null,G__47715));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__47716 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47716) : instaparse.cfg.build_rule.call(null,G__47716));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__47717 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47717) : instaparse.cfg.build_rule.call(null,G__47717));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__47718 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__47718) : instaparse.cfg.build_rule.call(null,G__47718));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47708__$1)].join('')));
...
while(true){
var G__47723 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__47757 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__47757;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47723__$1)].join('')));
...
var valid_nts_47758 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__47724_47759 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__47725_47760 = null;
var count__47726_47761 = (0);
var i__47727_47762 = (0);
while(true){
if((i__47727_47762 < count__47726_47761)){
var nt_47763 = chunk__47725_47760.cljs$core$IIndexed$_nth$arity$2(null,i__47727_47762);
if(cljs.core.truth_((valid_nts_47758.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47758.cljs$core$IFn$_invoke$arity$1(nt_47763) : valid_nts_47758.call(null,nt_47763)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_47763),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__47764 = seq__47724_47759;
var G__47765 = chunk__47725_47760;
var G__47766 = count__47726_47761;
var G__47767 = (i__47727_47762 + (1));
seq__47724_47759 = G__47764;
chunk__47725_47760 = G__47765;
count__47726_47761 = G__47766;
i__47727_47762 = G__47767;
continue;
} else {
var temp__5735__auto___47769 = cljs.core.seq(seq__47724_47759);
if(temp__5735__auto___47769){
var seq__47724_47770__$1 = temp__5735__auto___47769;
if(cljs.core.chunked_seq_QMARK_(seq__47724_47770__$1)){
var c__4556__auto___47771 = cljs.core.chunk_first(seq__47724_47770__$1);
var G__47772 = cljs.core.chunk_rest(seq__47724_47770__$1);
var G__47773 = c__4556__auto___47771;
var G__47774 = cljs.core.count(c__4556__auto___47771);
var G__47775 = (0);
seq__47724_47759 = G__47772;
chunk__47725_47760 = G__47773;
count__47726_47761 = G__47774;
i__47727_47762 = G__47775;
continue;
} else {
var nt_47776 = cljs.core.first(seq__47724_47770__$1);
if(cljs.core.truth_((valid_nts_47758.cljs$core$IFn$_invoke$arity$1 ? valid_nts_47758.cljs$core$IFn$_invoke$arity$1(nt_47776) : valid_nts_47758.call(null,nt_47776)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_47776),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__47777 = cljs.core.next(seq__47724_47770__$1);
var G__47778 = null;
var G__47779 = (0);
var G__47780 = (0);
seq__47724_47759 = G__47777;
chunk__47725_47760 = G__47778;
count__47726_47761 = G__47779;
i__47727_47762 = G__47780;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__47729_47781 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47730_47782 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47731_47783 = true;
var _STAR_print_fn_STAR__temp_val__47732_47784 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47731_47783);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47732_47784);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47730_47782);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47729_47781);
}
...
var G__47788 = (i__4737__auto___47786 + (1));
i__4737__auto___47786 = G__47788;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__47735){
...
var opts = map__47736__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__47738 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__47739 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__47739);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__47740_47789 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__47741_47790 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__47742_47791 = true;
var _STAR_print_fn_STAR__temp_val__47743_47792 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__47742_47791);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__47743_47792);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__47741_47790);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__47740_47789);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__47738);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq47733){
var G__47734 = cljs.core.first(seq47733);
var seq47733__$1 = cljs.core.next(seq47733);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47734,seq47733__$1);
}));
