...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23513){
...
}catch (e23538){var _e__20613__auto__ = e23538;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23540){var _e__20613__auto__ = e23540;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23546 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23547 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23547);

try{var map__23549 = opts;
var map__23549__$1 = (((((!((map__23549 == null))))?(((((map__23549.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23549.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23549):map__23549);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23549__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23546);
}});
...
var _STAR_print_level_STAR__orig_val__23554_23571 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23555_23572 = managed_print_level_23570;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23555_23572);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23551_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23551_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23554_23571);
}} else {
job_fn();
}
