...
var len__4736__auto___23566 = arguments.length;
var i__4737__auto___23567 = (0);
while(true){
if((i__4737__auto___23567 < len__4736__auto___23566)){
args__4742__auto__.push((arguments[i__4737__auto___23567]));

var G__23568 = (i__4737__auto___23567 + (1));
i__4737__auto___23567 = G__23568;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23520){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23531_SHARP_){
return (!((cljs.core.meta(p1__23531_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23541__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23545){var _e__20583__auto__ = e23545;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23547){var _e__20583__auto__ = e23547;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23550 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23551 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23551);

try{var map__23552 = opts;
var map__23552__$1 = (((((!((map__23552 == null))))?(((((map__23552.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23552.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23552):map__23552);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23552__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23550);
}});
...
var temp__5733__auto___23630 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23630)){
var managed_print_level_23631 = temp__5733__auto___23630;
var _STAR_print_level_STAR__orig_val__23560_23632 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23561_23633 = managed_print_level_23631;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23561_23633);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23557_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23557_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23560_23632);
}} else {
job_fn();
}
