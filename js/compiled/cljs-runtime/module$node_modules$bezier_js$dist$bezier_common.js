...
new Bezier(np);[0,1].forEach(function(t){if(2!==order||!t){var p=points[t+1],JSCompiler_object_inline_x_1570=p.x-o.x,JSCompiler_object_inline_y_1571=p.y-o.y,rc=distanceFn?distanceFn((t+1)/order):d$jscomp$0;distanceFn&&!clockwise&&(rc=-rc);var m=sqrt$1(JSCompiler_object_inline_x_1570*JSCompiler_object_inline_x_1570+JSCompiler_object_inline_y_1571*JSCompiler_object_inline_y_1571);np[t+1]={x:p.x+JSCompiler_object_inline_x_1570/m*rc,y:p.y+JSCompiler_object_inline_y_1571/m*rc}}});return new Bezier(np)}outline(d1,
