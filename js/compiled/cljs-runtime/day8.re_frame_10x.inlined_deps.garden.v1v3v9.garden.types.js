...
var expr__24677 = k__4388__auto__;
if(cljs.core.truth_((pred__24676.cljs$core$IFn$_invoke$arity$2 ? pred__24676.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unit","unit",375175175),expr__24677) : pred__24676.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__24677)))){
...
if(cljs.core.truth_((pred__24676.cljs$core$IFn$_invoke$arity$2 ? pred__24676.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__24677) : pred__24676.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__24677)))){
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k24684,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__24688 = k24684;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k24684,else__4383__auto__);
...
var vec__24694 = p__24689;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24694,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24694,(1),null);
return (f__4400__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4400__auto__.cljs$core$IFn$_invoke$arity$3(ret__4402__auto__,k__4403__auto__,v__4404__auto__) : f__4400__auto__.call(null,ret__4402__auto__,k__4403__auto__,v__4404__auto__));
}),init__4401__auto__,this__4399__auto____$1);
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__24683){
var self__ = this;
var G__24683__$1 = this;
return (new cljs.core.RecordIter((0),G__24683__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this24685,other24686){
var self__ = this;
var this24685__$1 = this;
return (((!((other24686 == null)))) && ((this24685__$1.constructor === other24686.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24685__$1.f,other24686.f)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24685__$1.args,other24686.args)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24685__$1.__extmap,other24686.__extmap)));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__24683){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__24715 = cljs.core.keyword_identical_QMARK_;
var expr__24716 = k__4388__auto__;
if(cljs.core.truth_((pred__24715.cljs$core$IFn$_invoke$arity$2 ? pred__24715.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__24716) : pred__24715.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__24716)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction(G__24683,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__24715.cljs$core$IFn$_invoke$arity$2 ? pred__24715.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"args","args",1315556576),expr__24716) : pred__24715.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__24716)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction(self__.f,G__24683,self__.__meta,self__.__extmap,null));
} else {
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction(self__.f,self__.args,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__24683),null));
}
}
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__24683){
var self__ = this;
var this__4379__auto____$1 = this;
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction(self__.f,self__.args,G__24683,self__.__extmap,self__.__hash));
}));
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.map__GT_CSSFunction = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$types$map__GT_CSSFunction(G__24687){
var extmap__4419__auto__ = (function (){var G__24720 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__24687,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"args","args",1315556576)], 0));
if(cljs.core.record_QMARK_(G__24687)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__24720);
} else {
return G__24720;
}
})();
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSFunction(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__24687),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__24687),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k24725,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__24729 = k24725;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k24725,else__4383__auto__);
...
var self__ = this;
var this__4399__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__24732){
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__24724){
var self__ = this;
var G__24724__$1 = this;
return (new cljs.core.RecordIter((0),G__24724__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this24726,other24727){
var self__ = this;
var this24726__$1 = this;
return (((!((other24727 == null)))) && ((this24726__$1.constructor === other24727.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24726__$1.identifier,other24727.identifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24726__$1.value,other24727.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24726__$1.__extmap,other24727.__extmap)));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__24724){
var self__ = this;
var this__4387__auto____$1 = this;
...
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule(G__24724,self__.value,self__.__meta,self__.__extmap,null));
} else {
...
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule(self__.identifier,G__24724,self__.__meta,self__.__extmap,null));
} else {
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__24724),null));
}
}
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__24724){
var self__ = this;
var this__4379__auto____$1 = this;
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.types.CSSAtRule(self__.identifier,self__.value,G__24724,self__.__extmap,self__.__hash));
}));
