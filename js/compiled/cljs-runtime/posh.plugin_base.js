...
var G__36124_36270 = conn;
var G__36125_36271 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766);
var G__36126_36272 = (function (var$){
...
var fexpr__36123_36273 = new cljs.core.Keyword(null,"listen!","listen!",-1756109477).cljs$core$IFn$_invoke$arity$1(dcfg);
(fexpr__36123_36273.cljs$core$IFn$_invoke$arity$3 ? fexpr__36123_36273.cljs$core$IFn$_invoke$arity$3(G__36124_36270,G__36125_36271,G__36126_36272) : fexpr__36123_36273.call(null,G__36124_36270,G__36125_36271,G__36126_36272));
...
var G__36128_36276 = conn;
var G__36129_36277 = new cljs.core.Keyword(null,"posh-listener","posh-listener",-6636061);
var G__36130_36278 = (function (tx_report){
...
var G__36280 = seq__36133;
var G__36281 = chunk__36134;
var G__36282 = count__36135;
var G__36283 = (i__36136 + (1));
seq__36133 = G__36280;
chunk__36134 = G__36281;
count__36135 = G__36282;
i__36136 = G__36283;
continue;
} else {
...
var G__36284 = cljs.core.chunk_rest(seq__36133__$1);
var G__36285 = c__4556__auto__;
var G__36286 = cljs.core.count(c__4556__auto__);
var G__36287 = (0);
seq__36133 = G__36284;
chunk__36134 = G__36285;
count__36135 = G__36286;
i__36136 = G__36287;
continue;
} else {
...
var fexpr__36127_36279 = new cljs.core.Keyword(null,"listen!","listen!",-1756109477).cljs$core$IFn$_invoke$arity$1(dcfg);
(fexpr__36127_36279.cljs$core$IFn$_invoke$arity$3 ? fexpr__36127_36279.cljs$core$IFn$_invoke$arity$3(G__36128_36276,G__36129_36277,G__36130_36278) : fexpr__36127_36279.call(null,G__36128_36276,G__36129_36277,G__36130_36278));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__36182,query_item){
var vec__36183 = p__36182;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36183,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36183,(1),null);
...
var args__4742__auto__ = [];
var len__4736__auto___36302 = arguments.length;
var i__4737__auto___36303 = (0);
while(true){
if((i__4737__auto___36303 < len__4736__auto___36302)){
args__4742__auto__.push((arguments[i__4737__auto___36303]));

var G__36304 = (i__4737__auto___36303 + (1));
i__4737__auto___36303 = G__36304;
continue;
} else {
}
break;
...
var vec__36202 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n_query_args,cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,cljs.core.PersistentArrayMap.EMPTY], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((n_query_args + (1)),cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.butlast(args),cljs.core.last(args)], null):(function(){throw "Incorrect number of args passed to posh query"})()
));
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36202,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36202,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36191_SHARP_){
if(cljs.core.truth_((function (){var fexpr__36208 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36208.cljs$core$IFn$_invoke$arity$1 ? fexpr__36208.cljs$core$IFn$_invoke$arity$1(p1__36191_SHARP_) : fexpr__36208.call(null,p1__36191_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__36191_SHARP_);
} else {
return p1__36191_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36192_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__36192_SHARP_);
}),args__$1)));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__36193_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__36193_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq36195){
var G__36196 = cljs.core.first(seq36195);
var seq36195__$1 = cljs.core.next(seq36195);
var G__36197 = cljs.core.first(seq36195__$1);
var seq36195__$2 = cljs.core.next(seq36195__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36196,G__36197,seq36195__$2);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36215_SHARP_){
if(cljs.core.truth_((function (){var fexpr__36228 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36228.cljs$core$IFn$_invoke$arity$1 ? fexpr__36228.cljs$core$IFn$_invoke$arity$1(p1__36215_SHARP_) : fexpr__36228.call(null,p1__36215_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__36215_SHARP_);
} else {
return p1__36215_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36217_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__36217_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq36218){
var G__36219 = cljs.core.first(seq36218);
var seq36218__$1 = cljs.core.next(seq36218);
var G__36220 = cljs.core.first(seq36218__$1);
var seq36218__$2 = cljs.core.next(seq36218__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36219,G__36220,seq36218__$2);
}));
...
/** @this {Function} */
(posh.plugin_base.q_tx.cljs$lang$applyTo = (function (seq36234){
var G__36235 = cljs.core.first(seq36234);
var seq36234__$1 = cljs.core.next(seq36234);
var G__36236 = cljs.core.first(seq36234__$1);
var seq36234__$2 = cljs.core.next(seq36234__$1);
var G__36237 = cljs.core.first(seq36234__$2);
var seq36234__$3 = cljs.core.next(seq36234__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36235,G__36236,G__36237,seq36234__$3);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___36312 = arguments.length;
var i__4737__auto___36313 = (0);
while(true){
if((i__4737__auto___36313 < len__4736__auto___36312)){
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36242_SHARP_){
if(cljs.core.truth_((function (){var fexpr__36251 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36251.cljs$core$IFn$_invoke$arity$1 ? fexpr__36251.cljs$core$IFn$_invoke$arity$1(p1__36242_SHARP_) : fexpr__36251.call(null,p1__36242_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__36242_SHARP_);
} else {
...
/** @this {Function} */
(posh.plugin_base.filter_q.cljs$lang$applyTo = (function (seq36244){
var G__36246 = cljs.core.first(seq36244);
var seq36244__$1 = cljs.core.next(seq36244);
var G__36247 = cljs.core.first(seq36244__$1);
var seq36244__$2 = cljs.core.next(seq36244__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36246,G__36247,seq36244__$2);
}));

posh.plugin_base.transact_BANG_ = (function posh$plugin_base$transact_BANG_(dcfg,poshdb_or_conn,txs){
var G__36258 = (cljs.core.truth_((function (){var fexpr__36260 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36260.cljs$core$IFn$_invoke$arity$1 ? fexpr__36260.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__36260.call(null,poshdb_or_conn));
})())?poshdb_or_conn:posh.stateful.poshdb__GT_conn(poshdb_or_conn));
var G__36259 = txs;
var fexpr__36257 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36257.cljs$core$IFn$_invoke$arity$2 ? fexpr__36257.cljs$core$IFn$_invoke$arity$2(G__36258,G__36259) : fexpr__36257.call(null,G__36258,G__36259));
});
