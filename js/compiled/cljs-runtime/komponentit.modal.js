 ...
 */
komponentit.modal.modal = (function komponentit$modal$modal(p__64096){
var map__64097 = p__64096;
var map__64097__$1 = (((((!((map__64097 == null))))?(((((map__64097.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64097.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64097):map__64097);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64097__$1,new cljs.core.Keyword(null,"title","title",636505583));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64097__$1,new cljs.core.Keyword(null,"content","content",15833224));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64097__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64097__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64097__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
 ...
 */
komponentit.modal.confirm_modal = (function komponentit$modal$confirm_modal(p__64100){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64101__$1,new cljs.core.Keyword(null,"title","title",636505583),"Yes or no?");
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64101__$1,new cljs.core.Keyword(null,"content","content",15833224),"Are you sure?");
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64101__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64101__$1,new cljs.core.Keyword(null,"success","success",1890645906));
var failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64101__$1,new cljs.core.Keyword(null,"failure","failure",720415879));
var cancel_label = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64101__$1,new cljs.core.Keyword(null,"cancel-label","cancel-label",-1093310551),"Cancel");
var ok_label = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64101__$1,new cljs.core.Keyword(null,"ok-label","ok-label",808114315),"OK");
