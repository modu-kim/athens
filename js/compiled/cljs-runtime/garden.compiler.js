...
var garden$compiler$IExpandable$expand$dyn_54340 = (function (this$){
...
return garden$compiler$IExpandable$expand$dyn_54340(this$);
}
});
...
var prefix = (function (p1__54205_SHARP_,p2__54206_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__54205_SHARP_,"-",p2__54206_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__54207){
var vec__54208 = p__54207;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54208,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54208,(1),null);
if(garden.util.hash_map_QMARK_(v)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__54211){
var vec__54212 = p__54211;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54212,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54212,(1),null);
...
var vec__54215 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54215,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54215,(1),null);
...
var vec__54218 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54218,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54218,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__54221 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__54222 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__54222);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__54221);
}})();
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54223 = cljs.core.get_global_hierarchy;
return (fexpr__54223.cljs$core$IFn$_invoke$arity$0 ? fexpr__54223.cljs$core$IFn$_invoke$arity$0() : fexpr__54223.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__54224){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54225__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54227 = value;
var map__54227__$1 = (((((!((map__54227 == null))))?(((((map__54227.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54227.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54227):map__54227);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54227__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54227__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__54229 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__54229) : garden.compiler.media_expression_behavior.call(null,G__54229));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__54230){
var map__54231 = p__54230;
var map__54231__$1 = (((((!((map__54231 == null))))?(((((map__54231.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54231.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54231):map__54231);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54231__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54233 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54233__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54233__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__54238 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__54239 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__54239);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__54238);
}})();
var vec__54234 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54234,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54234,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__54240){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54241__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54243 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54243__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54243__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__54248 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__54249 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__54249);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__54248);
}})();
var vec__54244 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54244,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54244,(1),null);
...
var garden$compiler$CSSRenderer$render_css$dyn_54355 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return garden$compiler$CSSRenderer$render_css$dyn_54355(this$);
}
});
...
var ys = (function (){var iter__4529__auto__ = (function garden$compiler$iter__54254(s__54255){
return (new cljs.core.LazySeq(null,(function (){
var s__54255__$1 = s__54255;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54255__$1);
if(temp__5735__auto__){
var s__54255__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54255__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54255__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54257 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54256 = (0);
while(true){
if((i__54256 < size__4528__auto__)){
var x = cljs.core._nth(c__4527__auto__,i__54256);
cljs.core.chunk_append(b__54257,((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))));

var G__54362 = (i__54256 + (1));
i__54256 = G__54362;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54257),garden$compiler$iter__54254(cljs.core.chunk_rest(s__54255__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54257),null);
}
} else {
var x = cljs.core.first(s__54255__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__54254(cljs.core.rest(s__54255__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__54258){
var vec__54259 = p__54258;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54259,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54259,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__54262_SHARP_){
return cljs.core.cons(p1__54262_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__54262_SHARP_) : f.call(null,p1__54262_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__54263){
var vec__54264 = p__54263;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54264,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54264,(1),null);
var iter__4529__auto__ = (function garden$compiler$prefixed_blocks_$_iter__54267(s__54268){
return (new cljs.core.LazySeq(null,(function (){
var s__54268__$1 = s__54268;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54268__$1);
if(temp__5735__auto__){
var s__54268__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54268__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54268__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54270 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54269 = (0);
while(true){
if((i__54269 < size__4528__auto__)){
var vendor = cljs.core._nth(c__4527__auto__,i__54269);
cljs.core.chunk_append(b__54270,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null));

var G__54374 = (i__54269 + (1));
i__54269 = G__54374;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54270),garden$compiler$prefixed_blocks_$_iter__54267(cljs.core.chunk_rest(s__54268__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54270),null);
}
} else {
var vendor = cljs.core.first(s__54268__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__54267(cljs.core.rest(s__54268__$2)));
}
} else {
return null;
}
...
var vec__54271 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54271,(0),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__54274){
var vec__54275 = p__54274;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54275,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54275,(1),null);
var rule = vec__54275;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__54278){
var vec__54279 = p__54278;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(1),null);
var vec__54282 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54282,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54282,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__54285){
...
var vec__54289 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54289,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54289,(1),null);
if(cljs.core.truth_((function (){var and__4115__auto__ = v;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54292__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54292__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54294__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54294__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__54296 = garden.color.as_hsl(c);
var map__54296__$1 = (((((!((map__54296 == null))))?(((((map__54296.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54296.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54296):map__54296);
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54296__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54296__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54296__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__54297 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54297,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54297,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54301 = cljs.core.get_global_hierarchy;
return (fexpr__54301.cljs$core$IFn$_invoke$arity$0 ? fexpr__54301.cljs$core$IFn$_invoke$arity$0() : fexpr__54301.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__54302){
var map__54303 = p__54302;
var map__54303__$1 = (((((!((map__54303 == null))))?(((((map__54303.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54303.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54303):map__54303);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54303__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54305 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54305__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54305__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__54308){
var map__54309 = p__54308;
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54311 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54311__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54311__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54307_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54307_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__54313){
var map__54314 = p__54313;
var map__54314__$1 = (((((!((map__54314 == null))))?(((((map__54314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54314):map__54314);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54314__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54316 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54316__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54316__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__54318){
var map__54319 = p__54318;
var map__54319__$1 = (((((!((map__54319 == null))))?(((((map__54319.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54319.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54319):map__54319);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54319__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54321 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54321__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54321__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var _STAR_flags_STAR__orig_val__54323 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__54324 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__54324);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__54323);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__54325,stylesheet){
...
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54326__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__54328,stylesheet){
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54329__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54329__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__54331,stylesheet){
var map__54332 = p__54331;
var map__54332__$1 = (((((!((map__54332 == null))))?(((((map__54332.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54332.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54332):map__54332);
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54332__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var vec__54336 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54336,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54336,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq54334){
var G__54335 = cljs.core.first(seq54334);
var seq54334__$1 = cljs.core.next(seq54334);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54335,seq54334__$1);
}));
