...
var prefix = (function (p1__54204_SHARP_,p2__54205_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__54204_SHARP_,"-",p2__54205_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__54206){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__54210){
var vec__54211 = p__54210;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54211,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54211,(1),null);
...
var vec__54214 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54214,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54214,(1),null);
...
var vec__54217 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54217,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54217,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__54220 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__54221 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__54221);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__54220);
}})();
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54222 = cljs.core.get_global_hierarchy;
return (fexpr__54222.cljs$core$IFn$_invoke$arity$0 ? fexpr__54222.cljs$core$IFn$_invoke$arity$0() : fexpr__54222.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__54223){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54224__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54226 = value;
var map__54226__$1 = (((((!((map__54226 == null))))?(((((map__54226.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54226.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54226):map__54226);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54226__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54226__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5733__auto__ = (function (){var G__54228 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__54228) : garden.compiler.media_expression_behavior.call(null,G__54228));
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__54229){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54230__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54232 = value;
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54232__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54232__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__54237 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__54238 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__54238);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__54237);
}})();
var vec__54233 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54233,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54233,(1),null);
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__54239){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54240__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54242 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54242__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54242__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var feature_queries__$1 = garden.compiler.expand_media_query_expression(feature_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__54247 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__54248 = feature_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__54248);

try{return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(garden.compiler.expand,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler.expand(rules)], 0)));
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__54247);
}})();
var vec__54243 = garden.compiler.divide_vec(garden.util.at_supports_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54243,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54243,(1),null);
...
var garden$compiler$CSSRenderer$render_css$dyn_54347 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return garden$compiler$CSSRenderer$render_css$dyn_54347(this$);
}
});
...
var ys = (function (){var iter__4529__auto__ = (function garden$compiler$iter__54253(s__54254){
return (new cljs.core.LazySeq(null,(function (){
var s__54254__$1 = s__54254;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54254__$1);
if(temp__5735__auto__){
var s__54254__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54254__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54254__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54256 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54255 = (0);
while(true){
if((i__54255 < size__4528__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54256),garden$compiler$iter__54253(cljs.core.chunk_rest(s__54254__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54256),null);
}
} else {
var x = cljs.core.first(s__54254__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__54253(cljs.core.rest(s__54254__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__54257){
var vec__54258 = p__54257;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54258,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54258,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__54261_SHARP_){
return cljs.core.cons(p1__54261_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__54261_SHARP_) : f.call(null,p1__54261_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__54262){
var vec__54263 = p__54262;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54263,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54263,(1),null);
var iter__4529__auto__ = (function garden$compiler$prefixed_blocks_$_iter__54266(s__54267){
return (new cljs.core.LazySeq(null,(function (){
var s__54267__$1 = s__54267;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54267__$1);
if(temp__5735__auto__){
var s__54267__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54267__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54267__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54269 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54268 = (0);
while(true){
if((i__54268 < size__4528__auto__)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54269),garden$compiler$prefixed_blocks_$_iter__54266(cljs.core.chunk_rest(s__54267__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54269),null);
}
} else {
var vendor = cljs.core.first(s__54267__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__54266(cljs.core.rest(s__54267__$2)));
}
} else {
return null;
}
...
var vec__54270 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54270,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54270,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__54273){
var vec__54274 = p__54273;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54274,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54274,(1),null);
var rule = vec__54274;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__54277){
...
var vec__54281 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54281,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54281,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
 ...
 */
garden.compiler.render_feature_expr_part = (function garden$compiler$render_feature_expr_part(p__54284){
...
var vec__54288 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54288,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54288,(1),null);
if(cljs.core.truth_((function (){var and__4115__auto__ = v;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(sv);
} else {
...
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54291__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54291__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54293__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54293__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__54295 = garden.color.as_hsl(c);
...
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54295__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54295__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54295__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__54296 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54296,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54296,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54300 = cljs.core.get_global_hierarchy;
return (fexpr__54300.cljs$core$IFn$_invoke$arity$0 ? fexpr__54300.cljs$core$IFn$_invoke$arity$0() : fexpr__54300.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__54301){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54302__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54304 = value;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54304__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54304__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__54307){
var map__54308 = p__54307;
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54308__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54310 = value;
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54310__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54310__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54306_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54306_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__54312){
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54315__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54315__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"feature","feature",27242652),(function (p__54317){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54318__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__54320 = value;
...
var feature_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54320__$1,new cljs.core.Keyword(null,"feature-queries","feature-queries",-1340998408));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54320__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
if(cljs.core.seq(rules)){
...
var _STAR_flags_STAR__orig_val__54322 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__54323 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__54323);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__54322);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__54324,stylesheet){
var map__54325 = p__54324;
var map__54325__$1 = (((((!((map__54325 == null))))?(((((map__54325.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54325.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54325):map__54325);
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54325__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__54327,stylesheet){
var map__54328 = p__54327;
...
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54328__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54328__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__54330,stylesheet){
...
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54331__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var vec__54335 = (cljs.core.truth_(((garden.util.hash_map_QMARK_(flags))?cljs.core.some(cljs.core.set(cljs.core.keys(flags)),cljs.core.keys(garden.compiler._STAR_flags_STAR_)):false))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([garden.compiler._STAR_flags_STAR_,flags], 0)),rules], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.compiler._STAR_flags_STAR_,cljs.core.cons(flags,rules)], null));
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54335,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54335,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq54333){
var G__54334 = cljs.core.first(seq54333);
var seq54333__$1 = cljs.core.next(seq54333);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54334,seq54333__$1);
}));
