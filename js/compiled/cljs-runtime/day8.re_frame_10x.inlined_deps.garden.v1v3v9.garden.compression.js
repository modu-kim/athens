 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25373){
var vec__25375 = p__25373;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25375,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25375,(1),null);
return (function (s){
...
var len__4736__auto___25398 = arguments.length;
var i__4737__auto___25399 = (0);
while(true){
if((i__4737__auto___25399 < len__4736__auto___25398)){
args__4742__auto__.push((arguments[i__4737__auto___25399]));

var G__25400 = (i__4737__auto___25399 + (1));
i__4737__auto___25399 = G__25400;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25379_SHARP_){
return (p1__25379_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25379_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25379_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25384){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25384));
}));
...
var map__25387 = temp__5733__auto__;
var map__25387__$1 = (((((!((map__25387 == null))))?(((((map__25387.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25387.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25387):map__25387);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25387__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25387__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25387__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25413 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25414 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25391 = tag;
