 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25382){
var vec__25383 = p__25382;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25383,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25383,(1),null);
return (function (s){
...
var len__4736__auto___25407 = arguments.length;
var i__4737__auto___25408 = (0);
while(true){
if((i__4737__auto___25408 < len__4736__auto___25407)){
args__4742__auto__.push((arguments[i__4737__auto___25408]));

var G__25410 = (i__4737__auto___25408 + (1));
i__4737__auto___25408 = G__25410;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25386_SHARP_){
return (p1__25386_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25386_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25386_SHARP_.call(null,s));
}),fs);
});
}));
...
var map__25396 = temp__5733__auto__;
var map__25396__$1 = (((((!((map__25396 == null))))?(((((map__25396.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25396.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25396):map__25396);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25396__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25396__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25396__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25417 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25418 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25406 = tag;
