 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25398){
var vec__25399 = p__25398;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25399,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25399,(1),null);
return (function (s){
...
var len__4736__auto___25415 = arguments.length;
var i__4737__auto___25416 = (0);
while(true){
if((i__4737__auto___25416 < len__4736__auto___25415)){
args__4742__auto__.push((arguments[i__4737__auto___25416]));

var G__25417 = (i__4737__auto___25416 + (1));
i__4737__auto___25416 = G__25417;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25404_SHARP_){
return (p1__25404_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25404_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25404_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25405){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25405));
}));
...
var map__25411 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25411__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25411__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25411__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25426 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25427 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25414 = tag;
