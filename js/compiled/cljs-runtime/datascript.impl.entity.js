...
var G__37875 = db;
var G__37876 = e;
var G__37877 = cljs.core.volatile_BANG_(false);
var G__37878 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__37875,G__37876,G__37877,G__37878) : datascript.impl.entity.__GT_Entity.call(null,G__37875,G__37876,G__37877,G__37878));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37879_SHARP_,p2__37880_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37879_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__37880_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37881_SHARP_,p2__37882_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37881_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__37882_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37888_SHARP_,p2__37890_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37888_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__37890_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__37892(s__37893){
return (new cljs.core.LazySeq(null,(function (){
var s__37893__$1 = s__37893;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__37893__$1);
if(temp__5735__auto__){
var s__37893__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37893__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__37893__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__37895 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__37894 = (0);
while(true){
if((i__37894 < size__4528__auto__)){
var vec__37896 = cljs.core._nth(c__4527__auto__,i__37894);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(1),null);
cljs.core.chunk_append(b__37895,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__37954 = (i__37894 + (1));
i__37894 = G__37954;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37895),datascript$impl$entity$js_seq_$_iter__37892(cljs.core.chunk_rest(s__37893__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37895),null);
}
} else {
var vec__37899 = cljs.core.first(s__37893__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__37892(cljs.core.rest(s__37893__$2)));
}
} else {
return null;
}
...
var G__37955 = null;
var G__37955__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__37903 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__37904 = null;
var count__37905 = (0);
var i__37906 = (0);
while(true){
if((i__37906 < count__37905)){
var vec__37913 = chunk__37904.cljs$core$IIndexed$_nth$arity$2(null,i__37906);
...
var G__37956 = seq__37903;
var G__37957 = chunk__37904;
var G__37958 = count__37905;
var G__37959 = (i__37906 + (1));
seq__37903 = G__37956;
chunk__37904 = G__37957;
count__37905 = G__37958;
i__37906 = G__37959;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__37903);
if(temp__5735__auto__){
var seq__37903__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__37903__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__37903__$1);
var G__37960 = cljs.core.chunk_rest(seq__37903__$1);
var G__37961 = c__4556__auto__;
var G__37962 = cljs.core.count(c__4556__auto__);
var G__37963 = (0);
seq__37903 = G__37960;
chunk__37904 = G__37961;
count__37905 = G__37962;
i__37906 = G__37963;
continue;
} else {
var vec__37916 = cljs.core.first(seq__37903__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37916,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37916,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__37964 = cljs.core.next(seq__37903__$1);
var G__37965 = null;
var G__37966 = (0);
var G__37967 = (0);
seq__37903 = G__37964;
chunk__37904 = G__37965;
count__37905 = G__37966;
i__37906 = G__37967;
continue;
}
} else {
...
var G__37955__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__37919 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__37920 = null;
var count__37921 = (0);
var i__37922 = (0);
while(true){
if((i__37922 < count__37921)){
var vec__37930 = chunk__37920.cljs$core$IIndexed$_nth$arity$2(null,i__37922);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37930,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37930,(1),null);
f.call(use_as_this,v,a,this$);


var G__37968 = seq__37919;
var G__37969 = chunk__37920;
var G__37970 = count__37921;
var G__37971 = (i__37922 + (1));
seq__37919 = G__37968;
chunk__37920 = G__37969;
count__37921 = G__37970;
i__37922 = G__37971;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__37919);
if(temp__5735__auto__){
var seq__37919__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__37919__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__37919__$1);
var G__37972 = cljs.core.chunk_rest(seq__37919__$1);
var G__37973 = c__4556__auto__;
var G__37974 = cljs.core.count(c__4556__auto__);
var G__37975 = (0);
seq__37919 = G__37972;
chunk__37920 = G__37973;
count__37921 = G__37974;
i__37922 = G__37975;
continue;
} else {
var vec__37933 = cljs.core.first(seq__37919__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37933,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37933,(1),null);
f.call(use_as_this,v,a,this$);


var G__37976 = cljs.core.next(seq__37919__$1);
var G__37977 = null;
var G__37978 = (0);
var G__37979 = (0);
seq__37919 = G__37976;
chunk__37920 = G__37977;
count__37921 = G__37978;
i__37922 = G__37979;
continue;
}
} else {
...
G__37955 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__37955__1.call(this,f);
case 2:
return G__37955__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__37955.cljs$core$IFn$_invoke$arity$1 = G__37955__1;
G__37955.cljs$core$IFn$_invoke$arity$2 = G__37955__2;
return G__37955;
})()
);
...
var G__37936 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__37936);
} else {
return G__37936;
}
}
...
var self__ = this;
var self__ = this;
var G__37937 = (arguments.length - (1));
switch (G__37937) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args37902){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args37902)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__37940 = cljs.core.deref(this$.cache);
return (fexpr__37940.cljs$core$IFn$_invoke$arity$1 ? fexpr__37940.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__37940.call(null,attr));
})();
...
var temp__5735__auto___38003 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___38003)){
var datoms_38006 = temp__5735__auto___38003;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_38006)));
