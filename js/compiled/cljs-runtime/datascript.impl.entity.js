...
var G__37871 = db;
var G__37872 = e;
var G__37873 = cljs.core.volatile_BANG_(false);
var G__37874 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__37871,G__37872,G__37873,G__37874) : datascript.impl.entity.__GT_Entity.call(null,G__37871,G__37872,G__37873,G__37874));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37875_SHARP_,p2__37876_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37875_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__37876_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37877_SHARP_,p2__37878_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37877_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__37878_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37883_SHARP_,p2__37884_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37883_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__37884_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__37886(s__37887){
return (new cljs.core.LazySeq(null,(function (){
var s__37887__$1 = s__37887;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__37887__$1);
if(temp__5735__auto__){
var s__37887__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37887__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__37887__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__37889 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__37888 = (0);
while(true){
if((i__37888 < size__4528__auto__)){
var vec__37894 = cljs.core._nth(c__4527__auto__,i__37888);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37894,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37894,(1),null);
cljs.core.chunk_append(b__37889,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__37954 = (i__37888 + (1));
i__37888 = G__37954;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37889),datascript$impl$entity$js_seq_$_iter__37886(cljs.core.chunk_rest(s__37887__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37889),null);
}
} else {
var vec__37898 = cljs.core.first(s__37887__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37898,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37898,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__37886(cljs.core.rest(s__37887__$2)));
}
} else {
return null;
}
...
var vec__37929 = chunk__37920.cljs$core$IIndexed$_nth$arity$2(null,i__37922);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37929,(0),null);
...
var vec__37932 = cljs.core.first(seq__37919__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37932,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37932,(1),null);
f.call(use_as_this,v,a,this$);
...
var G__37935 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__37935);
} else {
return G__37935;
}
}
...
var temp__5735__auto___37982 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___37982)){
var datoms_37983 = temp__5735__auto___37982;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_37983)));
