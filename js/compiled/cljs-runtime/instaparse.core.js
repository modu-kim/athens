...
if(cljs.core.truth_((function (){var fexpr__48257 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48257.cljs$core$IFn$_invoke$arity$1 ? fexpr__48257.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48257.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__48259 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48259.cljs$core$IFn$_invoke$arity$1 ? fexpr__48259.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48259.call(null,type));
})())){
} else {
...
var G__48260 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48260)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48260)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48260)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48260)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48260)].join('')));
...
var len__4736__auto___48339 = arguments.length;
var i__4737__auto___48341 = (0);
while(true){
if((i__4737__auto___48341 < len__4736__auto___48339)){
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48280){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48287 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48287) : instaparse.reduction.node_builders.call(null,G__48287));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48270){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48271,G__48272,seq48270__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___48347 = arguments.length;
var i__4737__auto___48348 = (0);
while(true){
if((i__4737__auto___48348 < len__4736__auto___48347)){
args__4742__auto__.push((arguments[i__4737__auto___48348]));

var G__48349 = (i__4737__auto___48348 + (1));
i__4737__auto___48348 = G__48349;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48300){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48307 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48307) : instaparse.reduction.node_builders.call(null,G__48307));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48296){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48297,G__48298,seq48296__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48313,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48313,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48319){
var vec__48320 = p__48319;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48320,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48320,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48314,other48315){
var self__ = this;
var this48314__$1 = this;
return (((!((other48315 == null)))) && ((this48314__$1.constructor === other48315.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48314__$1.grammar,other48315.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48314__$1.start_production,other48315.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48314__$1.output_format,other48315.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48314__$1.__extmap,other48315.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48312){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48323 = cljs.core.keyword_identical_QMARK_;
var expr__48324 = k__4388__auto__;
if(cljs.core.truth_((pred__48323.cljs$core$IFn$_invoke$arity$2 ? pred__48323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48324) : pred__48323.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48324)))){
return (new instaparse.core.Parser(G__48312,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48323.cljs$core$IFn$_invoke$arity$2 ? pred__48323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48324) : pred__48323.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48324)))){
return (new instaparse.core.Parser(self__.grammar,G__48312,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48323.cljs$core$IFn$_invoke$arity$2 ? pred__48323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48324) : pred__48323.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48324)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__48312,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48312),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48312){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__48312,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__48326 = (arguments.length - (1));
switch (G__48326) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args48317){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args48317)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__48316){
var extmap__4419__auto__ = (function (){var G__48327 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48316,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__48316)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48327);
} else {
return G__48327;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__48316),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__48316),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__48316),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___48418 = arguments.length;
var i__4737__auto___48419 = (0);
while(true){
if((i__4737__auto___48419 < len__4736__auto___48418)){
args__4742__auto__.push((arguments[i__4737__auto___48419]));

var G__48420 = (i__4737__auto___48419 + (1));
i__4737__auto___48419 = G__48420;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__48330){
...
var _STAR_case_insensitive_literals_STAR__orig_val__48333 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__48334 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__48334);

try{var G__48335 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48335__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__48333);
}});
...
var map__48336 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48336__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48336__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq48328){
var G__48329 = cljs.core.first(seq48328);
var seq48328__$1 = cljs.core.next(seq48328);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48329,seq48328__$1);
}));
