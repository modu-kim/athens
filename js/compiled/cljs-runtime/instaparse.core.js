...
if(cljs.core.truth_((function (){var fexpr__48265 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__48277 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48277.cljs$core$IFn$_invoke$arity$1 ? fexpr__48277.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48277.call(null,type));
})())){
} else {
...
var G__48278 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48278)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48278)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48278)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48278)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48278)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48295){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48302 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48302) : instaparse.reduction.node_builders.call(null,G__48302));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48285){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48286,G__48287,seq48285__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___48419 = arguments.length;
var i__4737__auto___48420 = (0);
while(true){
if((i__4737__auto___48420 < len__4736__auto___48419)){
args__4742__auto__.push((arguments[i__4737__auto___48420]));

var G__48421 = (i__4737__auto___48420 + (1));
i__4737__auto___48420 = G__48421;
continue;
} else {
}
break;
