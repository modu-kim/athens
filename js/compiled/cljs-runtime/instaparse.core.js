...
if(cljs.core.truth_((function (){var fexpr__48261 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48261.cljs$core$IFn$_invoke$arity$1 ? fexpr__48261.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48261.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__48266 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48266.cljs$core$IFn$_invoke$arity$1 ? fexpr__48266.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48266.call(null,type));
})())){
} else {
...
var G__48276 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48276)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48276)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48276)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48276)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48276)].join('')));
...
var len__4736__auto___48341 = arguments.length;
var i__4737__auto___48342 = (0);
while(true){
if((i__4737__auto___48342 < len__4736__auto___48341)){
args__4742__auto__.push((arguments[i__4737__auto___48342]));

var G__48343 = (i__4737__auto___48342 + (1));
i__4737__auto___48342 = G__48343;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48288){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48299 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48299) : instaparse.reduction.node_builders.call(null,G__48299));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48281){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48282,G__48283,seq48281__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___48350 = arguments.length;
var i__4737__auto___48351 = (0);
while(true){
if((i__4737__auto___48351 < len__4736__auto___48350)){
args__4742__auto__.push((arguments[i__4737__auto___48351]));

var G__48352 = (i__4737__auto___48351 + (1));
i__4737__auto___48351 = G__48352;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48311){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48314 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48314) : instaparse.reduction.node_builders.call(null,G__48314));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48304){
var G__48305 = cljs.core.first(seq48304);
var seq48304__$1 = cljs.core.next(seq48304);
var G__48306 = cljs.core.first(seq48304__$1);
var seq48304__$2 = cljs.core.next(seq48304__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48305,G__48306,seq48304__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48316,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48316,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48322){
var vec__48323 = p__48322;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48323,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48323,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48317,other48318){
var self__ = this;
var this48317__$1 = this;
return (((!((other48318 == null)))) && ((this48317__$1.constructor === other48318.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48317__$1.grammar,other48318.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48317__$1.start_production,other48318.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48317__$1.output_format,other48318.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48317__$1.__extmap,other48318.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48315){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48326 = cljs.core.keyword_identical_QMARK_;
var expr__48327 = k__4388__auto__;
if(cljs.core.truth_((pred__48326.cljs$core$IFn$_invoke$arity$2 ? pred__48326.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48327) : pred__48326.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48327)))){
return (new instaparse.core.Parser(G__48315,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48326.cljs$core$IFn$_invoke$arity$2 ? pred__48326.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48327) : pred__48326.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48327)))){
return (new instaparse.core.Parser(self__.grammar,G__48315,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48326.cljs$core$IFn$_invoke$arity$2 ? pred__48326.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48327) : pred__48326.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48327)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__48315,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48315),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48315){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__48315,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__48329 = (arguments.length - (1));
switch (G__48329) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args48320){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args48320)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__48319){
var extmap__4419__auto__ = (function (){var G__48330 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48319,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__48319)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48330);
} else {
return G__48330;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__48319),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__48319),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__48319),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___48421 = arguments.length;
var i__4737__auto___48422 = (0);
while(true){
if((i__4737__auto___48422 < len__4736__auto___48421)){
args__4742__auto__.push((arguments[i__4737__auto___48422]));

var G__48423 = (i__4737__auto___48422 + (1));
i__4737__auto___48422 = G__48423;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__48333){
...
var _STAR_case_insensitive_literals_STAR__orig_val__48336 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__48337 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__48337);

try{var G__48338 = input_format;
var G__48338__$1 = (((G__48338 instanceof cljs.core.Keyword))?G__48338.fqn:null);
switch (G__48338__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48338__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__48336);
}});
...
var map__48339 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48339__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48339__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq48331){
var G__48332 = cljs.core.first(seq48331);
var seq48331__$1 = cljs.core.next(seq48331);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48332,seq48331__$1);
}));
