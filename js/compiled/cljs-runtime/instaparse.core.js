...
if(cljs.core.truth_((function (){var fexpr__48260 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48260.cljs$core$IFn$_invoke$arity$1 ? fexpr__48260.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48260.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__48262 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48262.cljs$core$IFn$_invoke$arity$1 ? fexpr__48262.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48262.call(null,type));
})())){
} else {
...
var G__48263 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48263)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48263)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48263)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48263)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48263)].join('')));
...
var len__4736__auto___48346 = arguments.length;
var i__4737__auto___48347 = (0);
while(true){
if((i__4737__auto___48347 < len__4736__auto___48346)){
args__4742__auto__.push((arguments[i__4737__auto___48347]));

var G__48349 = (i__4737__auto___48347 + (1));
i__4737__auto___48347 = G__48349;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48282){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48286 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48286) : instaparse.reduction.node_builders.call(null,G__48286));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48271){
...
var args__4742__auto__ = [];
var len__4736__auto___48356 = arguments.length;
var i__4737__auto___48357 = (0);
while(true){
if((i__4737__auto___48357 < len__4736__auto___48356)){
args__4742__auto__.push((arguments[i__4737__auto___48357]));

var G__48358 = (i__4737__auto___48357 + (1));
i__4737__auto___48357 = G__48358;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48302){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48306 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48306) : instaparse.reduction.node_builders.call(null,G__48306));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48292){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48293,G__48294,seq48292__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48312,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48312,else__4383__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48313,other48314){
var self__ = this;
var this48313__$1 = this;
return (((!((other48314 == null)))) && ((this48313__$1.constructor === other48314.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48313__$1.grammar,other48314.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48313__$1.start_production,other48314.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48313__$1.output_format,other48314.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48313__$1.__extmap,other48314.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48311){
var self__ = this;
...
return (new instaparse.core.Parser(G__48311,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__48311,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__48311,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48311),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48311){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__48311,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__48315){
var extmap__4419__auto__ = (function (){var G__48330 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48315,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__48315)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48330);
} else {
return G__48330;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__48315),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__48315),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__48315),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__48447 = (i__4737__auto___48446 + (1));
i__4737__auto___48446 = G__48447;
continue;
} else {
}
break;
