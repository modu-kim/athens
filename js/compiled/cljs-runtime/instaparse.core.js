...
var G__48345 = (i__4737__auto___48343 + (1));
i__4737__auto___48343 = G__48345;
continue;
} else {
}
break;
...
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48287,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48287,(1),null);
...
var pred__48317 = cljs.core.keyword_identical_QMARK_;
var expr__48318 = k__4388__auto__;
if(cljs.core.truth_((pred__48317.cljs$core$IFn$_invoke$arity$2 ? pred__48317.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48318) : pred__48317.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48318)))){
...
if(cljs.core.truth_((pred__48317.cljs$core$IFn$_invoke$arity$2 ? pred__48317.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48318) : pred__48317.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48318)))){
return (new instaparse.core.Parser(self__.grammar,G__48277,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48317.cljs$core$IFn$_invoke$arity$2 ? pred__48317.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48318) : pred__48317.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48318)))){
...
var self__ = this;
var self__ = this;
var G__48324 = (arguments.length - (1));
switch (G__48324) {
case (1):
...
var G__48446 = (i__4737__auto___48442 + (1));
i__4737__auto___48442 = G__48446;
continue;
} else {
}
break;
