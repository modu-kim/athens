...
var re_frame$router$IEventQueue$add_post_event_callback$dyn_32377 = (function (this$,id,callack){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$add_post_event_callback$dyn_32377(this$,id,callack);
}
});

var re_frame$router$IEventQueue$remove_post_event_callback$dyn_32380 = (function (this$,f){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$remove_post_event_callback$dyn_32380(this$,f);
}
});

var re_frame$router$IEventQueue$purge$dyn_32382 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$purge$dyn_32382(this$);
}
});

var re_frame$router$IEventQueue$_fsm_trigger$dyn_32384 = (function (this$,trigger,arg){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_fsm_trigger$dyn_32384(this$,trigger,arg);
}
});

var re_frame$router$IEventQueue$_add_event$dyn_32386 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_add_event$dyn_32386(this$,event);
}
});

var re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_32388 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_32388(this$);
}
});

var re_frame$router$IEventQueue$_run_next_tick$dyn_32392 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_next_tick$dyn_32392(this$);
}
});

var re_frame$router$IEventQueue$_run_queue$dyn_32394 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_queue$dyn_32394(this$);
}
});

var re_frame$router$IEventQueue$_exception$dyn_32396 = (function (this$,ex){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_exception$dyn_32396(this$,ex);
}
});

var re_frame$router$IEventQueue$_pause$dyn_32397 = (function (this$,later_fn){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_pause$dyn_32397(this$,later_fn);
}
});

var re_frame$router$IEventQueue$_resume$dyn_32399 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_resume$dyn_32399(this$);
}
});

var re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_32403 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_32403(this$,event);
}
});
...
try{try{var vec__32317 = (function (){var G__32320 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"exception","exception",-335277064)], null),G__32320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"finish-run","finish-run",753148477)], null),G__32320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"pause","pause",-2095325672)], null),G__32320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"resume","resume",-118572261)], null),G__32320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027)], null),G__32320)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_run_queue$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32320)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32320)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32320)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
...
var new_fsm_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32317,(0),null);
var action_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32317,(1),null);
if(re_frame.trace.is_trace_enabled_QMARK_()){
...
var end__32149__auto___32415 = re_frame.interop.now();
var duration__32150__auto___32416 = (end__32149__auto___32415 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__32150__auto___32416,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__32149__auto___32415);
} else {
}
...
return (later_fn.cljs$core$IFn$_invoke$arity$1 ? later_fn.cljs$core$IFn$_invoke$arity$1(G__32335) : later_fn.call(null,G__32335));
}));
...
var self__ = this;
var ___$1 = this;
var seq__32342 = cljs.core.seq(cljs.core.vals(self__.post_event_callback_fns));
var chunk__32343 = null;
var count__32344 = (0);
var i__32345 = (0);
while(true){
if((i__32345 < count__32344)){
var callback = chunk__32343.cljs$core$IIndexed$_nth$arity$2(null,i__32345);
...
var G__32427 = seq__32342;
var G__32428 = chunk__32343;
var G__32429 = count__32344;
var G__32430 = (i__32345 + (1));
seq__32342 = G__32427;
chunk__32343 = G__32428;
count__32344 = G__32429;
i__32345 = G__32430;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__32342);
if(temp__5735__auto__){
var seq__32342__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__32342__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__32342__$1);
var G__32431 = cljs.core.chunk_rest(seq__32342__$1);
var G__32432 = c__4556__auto__;
var G__32433 = cljs.core.count(c__4556__auto__);
var G__32434 = (0);
seq__32342 = G__32431;
chunk__32343 = G__32432;
count__32344 = G__32433;
i__32345 = G__32434;
continue;
} else {
var callback = cljs.core.first(seq__32342__$1);
(callback.cljs$core$IFn$_invoke$arity$2 ? callback.cljs$core$IFn$_invoke$arity$2(event_v,self__.queue) : callback.call(null,event_v,self__.queue));


var G__32435 = cljs.core.next(seq__32342__$1);
var G__32436 = null;
var G__32437 = (0);
var G__32438 = (0);
seq__32342 = G__32435;
chunk__32343 = G__32436;
count__32344 = G__32437;
i__32345 = G__32438;
continue;
}
} else {
