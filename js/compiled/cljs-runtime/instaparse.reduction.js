...
var G__46706 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__46709(s__46710){
return (new cljs.core.LazySeq(null,(function (){
var s__46710__$1 = s__46710;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46710__$1);
if(temp__5735__auto__){
var s__46710__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46710__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__46710__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__46712 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__46711 = (0);
while(true){
if((i__46711 < size__4528__auto__)){
var vec__46713 = cljs.core._nth(c__4527__auto__,i__46711);
...
cljs.core.chunk_append(b__46712,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__46721 = (i__46711 + (1));
i__46711 = G__46721;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46712),instaparse$reduction$iter__46709(cljs.core.chunk_rest(s__46710__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46712),null);
}
} else {
var vec__46716 = cljs.core.first(s__46710__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__46709(cljs.core.rest(s__46710__$2)));
}
} else {
return null;
}
