...
var G__46708 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__46711(s__46712){
return (new cljs.core.LazySeq(null,(function (){
var s__46712__$1 = s__46712;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46712__$1);
if(temp__5735__auto__){
var s__46712__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46712__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__46712__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__46714 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__46713 = (0);
while(true){
if((i__46713 < size__4528__auto__)){
var vec__46715 = cljs.core._nth(c__4527__auto__,i__46713);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46715,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46715,(1),null);
cljs.core.chunk_append(b__46714,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__46728 = (i__46713 + (1));
i__46713 = G__46728;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46714),instaparse$reduction$iter__46711(cljs.core.chunk_rest(s__46712__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46714),null);
}
} else {
var vec__46718 = cljs.core.first(s__46712__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46718,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46718,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__46711(cljs.core.rest(s__46712__$2)));
}
} else {
return null;
}
