...
var vec__58153 = cljs.core.rest(expr);
var seq__58154 = cljs.core.seq(vec__58153);
var first__58155 = cljs.core.first(seq__58154);
var seq__58154__$1 = cljs.core.next(seq__58154);
var vec__58156 = first__58155;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58156,(0),null);
var form = seq__58154__$1;
...
var G__58159 = x;
var G__58159__$1 = (((G__58159 == null))?null:spec_tools.impl.polish(G__58159));
var G__58159__$2 = (((G__58159__$1 == null))?null:cljs.core.name(G__58159__$1));
if((G__58159__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__58159__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__58160 = x;
var G__58160__$1 = (((G__58160 == null))?null:cljs.core.name(G__58160));
if((G__58160__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__58160__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__58161){
...
var data = map__58162__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58162__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58162__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58162__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58162__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__58164){
...
var data = map__58165__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58165__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58165__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__58167 = data;
var G__58167__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58167,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__58167);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58167__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__58167__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__58171 = form;
var G__58171__$1 = (((G__58171 == null))?null:cljs.core.rest(G__58171));
if((G__58171__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__58171__$1);
}
})();
var G__58172 = m;
var G__58172__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58172,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__58168_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__58168_SHARP_)));
})):G__58172);
var G__58172__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58172__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__58169_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__58169_SHARP_)));
})):G__58172__$1);
var G__58172__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58172__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__58170_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__58170_SHARP_));
})):G__58172__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__58172__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__58173 = (function (){var G__58174 = form;
var G__58174__$1 = (((G__58174 == null))?null:cljs.core.rest(G__58174));
if((G__58174__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__58174__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58173__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58173__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58173__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58173__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__58176 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__58176) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__58177 = form;
var G__58177__$1 = (((G__58177 == null))?null:cljs.core.seq(G__58177));
var G__58177__$2 = (((G__58177__$1 == null))?null:cljs.core.first(G__58177__$1));
if((G__58177__$2 == null)){
return null;
} else {
var fexpr__58178 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__58178.cljs$core$IFn$_invoke$arity$1 ? fexpr__58178.cljs$core$IFn$_invoke$arity$1(G__58177__$2) : fexpr__58178.call(null,G__58177__$2));
}
})():null));
});
/**
...
var len__4736__auto___58199 = arguments.length;
var i__4737__auto___58200 = (0);
while(true){
if((i__4737__auto___58200 < len__4736__auto___58199)){
args__4742__auto__.push((arguments[i__4737__auto___58200]));

var G__58201 = (i__4737__auto___58200 + (1));
i__4737__auto___58200 = G__58201;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq58179){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58179));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__58180){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__58186){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__58184_SHARP_){
return cljs.core.map_QMARK_(p1__58184_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__58185_SHARP_){
return cljs.core.contains_QMARK_(p1__58185_SHARP_,x);
});
}),req_keys));
