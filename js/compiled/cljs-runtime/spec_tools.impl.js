...
var vec__58151 = cljs.core.rest(expr);
...
var vec__58154 = first__58153;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58154,(0),null);
var form = seq__58152__$1;
...
var G__58157 = x;
var G__58157__$1 = (((G__58157 == null))?null:spec_tools.impl.polish(G__58157));
var G__58157__$2 = (((G__58157__$1 == null))?null:cljs.core.name(G__58157__$1));
if((G__58157__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__58157__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__58158 = x;
var G__58158__$1 = (((G__58158 == null))?null:cljs.core.name(G__58158));
if((G__58158__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__58158__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__58159){
...
var data = map__58160__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58160__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58160__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58160__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58160__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__58162){
...
var data = map__58163__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__58165 = data;
var G__58165__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58165,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__58165);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58165__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__58165__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__58169 = form;
var G__58169__$1 = (((G__58169 == null))?null:cljs.core.rest(G__58169));
if((G__58169__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__58169__$1);
}
})();
var G__58170 = m;
var G__58170__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58170,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__58166_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__58166_SHARP_)));
})):G__58170);
var G__58170__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58170__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__58167_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__58167_SHARP_)));
})):G__58170__$1);
var G__58170__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58170__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__58168_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__58168_SHARP_));
})):G__58170__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__58170__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__58171 = (function (){var G__58172 = form;
var G__58172__$1 = (((G__58172 == null))?null:cljs.core.rest(G__58172));
if((G__58172__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__58172__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58171__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58171__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58171__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58171__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__58174 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__58174) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__58175 = form;
var G__58175__$1 = (((G__58175 == null))?null:cljs.core.seq(G__58175));
var G__58175__$2 = (((G__58175__$1 == null))?null:cljs.core.first(G__58175__$1));
if((G__58175__$2 == null)){
return null;
} else {
var fexpr__58176 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__58176.cljs$core$IFn$_invoke$arity$1 ? fexpr__58176.cljs$core$IFn$_invoke$arity$1(G__58175__$2) : fexpr__58176.call(null,G__58175__$2));
}
})():null));
});
/**
...
var len__4736__auto___58197 = arguments.length;
var i__4737__auto___58198 = (0);
while(true){
if((i__4737__auto___58198 < len__4736__auto___58197)){
args__4742__auto__.push((arguments[i__4737__auto___58198]));

var G__58199 = (i__4737__auto___58198 + (1));
i__4737__auto___58198 = G__58199;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq58177){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__58178){
var vec__58179 = p__58178;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58179,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58179,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__58184){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58185__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58185__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58185__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58185__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__58182_SHARP_){
return cljs.core.map_QMARK_(p1__58182_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__58183_SHARP_){
return cljs.core.contains_QMARK_(p1__58183_SHARP_,x);
});
}),req_keys));
