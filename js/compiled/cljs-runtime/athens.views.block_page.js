...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62090__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62090__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62090__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62096__$1,new cljs.core.Keyword("node","title","node/title",628940777));
...
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62096__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
cljs.core.chunk_append(b__62095,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["breadcrumb-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(uid__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__62094,map__62096,map__62096__$1,title,uid__$1,string__$1,c__4527__auto__,size__4528__auto__,b__62095,s__62093__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__62094,map__62096,map__62096__$1,title,uid__$1,string__$1,c__4527__auto__,size__4528__auto__,b__62095,s__62093__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62095),athens$views$block_page$block_page_el_$_iter__62092(cljs.core.chunk_rest(s__62093__$2)));
} else {
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["breadcrumb-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(uid__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__62098,map__62098__$1,title,uid__$1,string__$1,s__62093__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__62098,map__62098__$1,title,uid__$1,string__$1,s__62093__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state))
], null),(function (){var or__4126__auto__ = title;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1], null)),athens$views$block_page$block_page_el_$_iter__62092(cljs.core.rest(s__62093__$2)));
}
} else {
return null;
}
...
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword("string","local","string/local",-578009907).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4529__auto__ = (function athens$views$block_page$block_page_el_$_iter__62100(s__62101){
return (new cljs.core.LazySeq(null,(function (){
var s__62101__$1 = s__62101;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__62101__$1);
if(temp__5735__auto__){
var s__62101__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__62101__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__62101__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__62103 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__62102 = (0);
while(true){
if((i__62102 < size__4528__auto__)){
var child = cljs.core._nth(c__4527__auto__,i__62102);
cljs.core.chunk_append(b__62103,(function (){var map__62104 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62104__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62103),athens$views$block_page$block_page_el_$_iter__62100(cljs.core.chunk_rest(s__62101__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62103),null);
}
} else {
var child = cljs.core.first(s__62101__$2);
return cljs.core.cons((function (){var map__62106 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62106__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$views$block_page$block_page_el_$_iter__62100(cljs.core.rest(s__62101__$2)));
}
} else {
return null;
}
...
var vec__62113 = cljs.core._nth(c__4527__auto__,i__62110);
...
cljs.core.chunk_append(b__62111,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.node_page.references_group_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["group-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(group_title)].join('')], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.node_page.references_group_title_style),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__62110,vec__62113,group_title,group,c__4527__auto__,size__4528__auto__,b__62111,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function (){
...
});})(i__62110,vec__62113,group_title,group,c__4527__auto__,size__4528__auto__,b__62111,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state))
], null),group_title], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = ((function (i__62110,vec__62113,group_title,group,c__4527__auto__,size__4528__auto__,b__62111,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function athens$views$block_page$block_page_el_$_iter__62108_$_iter__62116(s__62117){
return (new cljs.core.LazySeq(null,((function (i__62110,vec__62113,group_title,group,c__4527__auto__,size__4528__auto__,b__62111,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62119),athens$views$block_page$block_page_el_$_iter__62108_$_iter__62116(cljs.core.chunk_rest(s__62117__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62119),null);
}
} else {
var block__$1 = cljs.core.first(s__62117__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.node_page.references_group_block_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["ref-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block__$1))].join('')], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.node_page.ref_comp,block__$1], null)], null),athens$views$block_page$block_page_el_$_iter__62108_$_iter__62116(cljs.core.rest(s__62117__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62111),athens$views$block_page$block_page_el_$_iter__62108(cljs.core.chunk_rest(s__62109__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62111),null);
}
} else {
var vec__62120 = cljs.core.first(s__62109__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.node_page.references_group_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["group-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(group_title)].join('')], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.node_page.references_group_title_style),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__62120,group_title,group,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(athens.parse_renderer.pull_node_from_string(group_title))));
});})(vec__62120,group_title,group,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state))
], null),group_title], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = ((function (vec__62120,group_title,group,s__62109__$2,temp__5735__auto__,map__62090,map__62090__$1,string,children,uid,state){
return (function athens$views$block_page$block_page_el_$_iter__62108_$_iter__62123(s__62124){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62126),athens$views$block_page$block_page_el_$_iter__62108_$_iter__62123(cljs.core.chunk_rest(s__62124__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62126),null);
}
} else {
var block__$1 = cljs.core.first(s__62124__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.views.node_page.references_group_block_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["ref-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block__$1))].join('')], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.node_page.ref_comp,block__$1], null)], null),athens$views$block_page$block_page_el_$_iter__62108_$_iter__62123(cljs.core.rest(s__62124__$2)));
}
} else {
return null;
}
...
;
return iter__4529__auto__(group);
})())], null),athens$views$block_page$block_page_el_$_iter__62108(cljs.core.rest(s__62109__$2)));
}
} else {
return null;
}
