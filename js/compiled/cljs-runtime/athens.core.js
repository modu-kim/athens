...
return module$node_modules$$sentry$react$dist$index.init(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"dsn","dsn",1561266567),athens.core.SENTRY_DSN,new cljs.core.Keyword(null,"release","release",-1534371381),["athens@",cljs.core.str.cljs$core$IFn$_invoke$arity$1(athens.util.athens_version())].join(''),new cljs.core.Keyword(null,"integrations","integrations",1844532423),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new module$node_modules$$sentry$tracing$dist$index.Integrations.BrowserTracing()),(new module$node_modules$$sentry$integrations$dist$index.CaptureConsole(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"levels","levels",-950747887),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["warn","error","debug","assert"], null)], null))))], null),new cljs.core.Keyword(null,"environment","environment",-666037640),((athens.config.debug_QMARK_)?"development":"production"),new cljs.core.Keyword(null,"beforeSend","beforeSend",-1560616376),(function (p1__64232_SHARP_){
if(athens.core.sentry_on_QMARK_()){
return p1__64232_SHARP_;
} else {
return null;
}
