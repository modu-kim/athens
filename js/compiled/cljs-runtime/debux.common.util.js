...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57157_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57157_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57156_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57156_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57158_SHARP_){
return (((p1__57158_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57158_SHARP_) == null)));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57198){
var vec__57203 = p__57198;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57203,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57196){
var G__57197 = cljs.core.first(seq57196);
var seq57196__$1 = cljs.core.next(seq57196);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57197,seq57196__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57220_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57220_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57229_57276 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57230_57277 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57231_57278 = true;
var _STAR_print_fn_STAR__temp_val__57232_57279 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57231_57278);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57232_57279);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57230_57277);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57229_57276);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57228_SHARP_){
return debux.common.util.prepend_bars(p1__57228_SHARP_,indent_level);
...
if(typeof f === 'string'){
var G__57285 = cljs.core.next(opts__$1);
var G__57286 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57285;
acc = G__57286;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57287 = cljs.core.nnext(opts__$1);
var G__57288 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57287;
acc = G__57288;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57289 = cljs.core.next(opts__$1);
var G__57290 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57289;
acc = G__57290;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57235 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57235.cljs$core$IFn$_invoke$arity$1 ? fexpr__57235.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57235.call(null,f));
})())){
var G__57292 = cljs.core.next(opts__$1);
var G__57293 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57292;
acc = G__57293;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57238 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57238.cljs$core$IFn$_invoke$arity$1 ? fexpr__57238.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57238.call(null,f));
})())){
var G__57298 = cljs.core.nnext(opts__$1);
var G__57299 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57298;
acc = G__57299;
continue;
} else {
...
var G__57305 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57304;
acc = G__57305;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57239){
var vec__57240 = p__57239;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57240,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57240,(1),null);
...
var G__57244 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57243 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57243.cljs$core$IFn$_invoke$arity$1 ? fexpr__57243.cljs$core$IFn$_invoke$arity$1(G__57244) : fexpr__57243.call(null,G__57244));
});
...
return (function() { 
var G__57316__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57250 = quoted_form;
var G__57251 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57250,G__57251) : debux.common.util.remove_d.call(null,G__57250,G__57251));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57316 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57317__i = 0, G__57317__a = new Array(arguments.length -  0);
while (G__57317__i < G__57317__a.length) {G__57317__a[G__57317__i] = arguments[G__57317__i + 0]; ++G__57317__i;}
  arg = new cljs.core.IndexedSeq(G__57317__a,0,null);
} 
return G__57316__delegate.call(this,arg);};
G__57316.cljs$lang$maxFixedArity = 0;
G__57316.cljs$lang$applyTo = (function (arglist__57318){
var arg = cljs.core.seq(arglist__57318);
return G__57316__delegate(arg);
});
G__57316.cljs$core$IFn$_invoke$arity$variadic = G__57316__delegate;
return G__57316;
})()
;
});
...
var G__57319 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57319;
continue;
} else {
...
var G__57320 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57320;
continue;
} else {
var G__57321 = clojure.zip.next(loc);
loc = G__57321;
continue;
