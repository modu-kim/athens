...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57187_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57187_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57186_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57186_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57188_SHARP_){
return (((p1__57188_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57188_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57193,mapping){
var map__57194 = p__57193;
var map__57194__$1 = (((((!((map__57194 == null))))?(((((map__57194.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57194.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57194):map__57194);
var state = map__57194__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57194__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57194__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57194__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57191_SHARP_){
if((p1__57191_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57191_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57293 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57295 = clojure.zip.next(loc);
loc = G__57295;
continue;
}
}
...
var len__4736__auto___57298 = arguments.length;
var i__4737__auto___57299 = (0);
while(true){
if((i__4737__auto___57299 < len__4736__auto___57298)){
args__4742__auto__.push((arguments[i__4737__auto___57299]));

var G__57300 = (i__4737__auto___57299 + (1));
i__4737__auto___57299 = G__57300;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57234){
var vec__57239 = p__57234;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57239,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57228){
var G__57229 = cljs.core.first(seq57228);
var seq57228__$1 = cljs.core.next(seq57228);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57229,seq57228__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57242_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57242_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57246_57301 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57247_57302 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57248_57303 = true;
var _STAR_print_fn_STAR__temp_val__57249_57304 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57248_57303);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57249_57304);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57247_57302);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57246_57301);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57244_SHARP_){
return debux.common.util.prepend_bars(p1__57244_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57305 = cljs.core.next(opts__$1);
var G__57306 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57305;
acc = G__57306;
continue;
} else {
if(typeof f === 'string'){
var G__57307 = cljs.core.next(opts__$1);
var G__57308 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57307;
acc = G__57308;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57309 = cljs.core.nnext(opts__$1);
var G__57310 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57309;
acc = G__57310;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57311 = cljs.core.next(opts__$1);
var G__57312 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57311;
acc = G__57312;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57252 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57252.cljs$core$IFn$_invoke$arity$1 ? fexpr__57252.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57252.call(null,f));
})())){
var G__57313 = cljs.core.next(opts__$1);
var G__57314 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57313;
acc = G__57314;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57253 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57253.cljs$core$IFn$_invoke$arity$1 ? fexpr__57253.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57253.call(null,f));
})())){
var G__57315 = cljs.core.nnext(opts__$1);
var G__57316 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57315;
acc = G__57316;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57317 = cljs.core.next(opts__$1);
var G__57318 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57317;
acc = G__57318;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57255){
var vec__57257 = p__57255;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57257,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57257,(1),null);
...
var G__57261 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57260 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57260.cljs$core$IFn$_invoke$arity$1 ? fexpr__57260.cljs$core$IFn$_invoke$arity$1(G__57261) : fexpr__57260.call(null,G__57261));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57263 = quoted_form;
var G__57264 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57263,G__57264) : debux.common.util.remove_d.call(null,G__57263,G__57264));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57265 = quoted_form;
var G__57266 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57265,G__57266) : debux.common.util.remove_d.call(null,G__57265,G__57266));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57319__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57267 = quoted_form;
var G__57268 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57267,G__57268) : debux.common.util.remove_d.call(null,G__57267,G__57268));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57319 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57320__i = 0, G__57320__a = new Array(arguments.length -  0);
while (G__57320__i < G__57320__a.length) {G__57320__a[G__57320__i] = arguments[G__57320__i + 0]; ++G__57320__i;}
  arg = new cljs.core.IndexedSeq(G__57320__a,0,null);
} 
return G__57319__delegate.call(this,arg);};
G__57319.cljs$lang$maxFixedArity = 0;
G__57319.cljs$lang$applyTo = (function (arglist__57321){
var arg = cljs.core.seq(arglist__57321);
return G__57319__delegate(arg);
});
G__57319.cljs$core$IFn$_invoke$arity$variadic = G__57319__delegate;
return G__57319;
})()
;
});
...
var G__57322 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57322;
continue;
} else {
...
var G__57323 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57323;
continue;
} else {
var G__57324 = clojure.zip.next(loc);
loc = G__57324;
continue;
