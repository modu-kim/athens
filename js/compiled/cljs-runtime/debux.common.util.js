...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57151_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57151_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57150_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57150_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57155_SHARP_){
return (((p1__57155_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57155_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57162,mapping){
...
var state = map__57163__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57163__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57163__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57163__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57160_SHARP_){
if((p1__57160_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57160_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57252 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57253 = clojure.zip.next(loc);
loc = G__57253;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57180){
var vec__57181 = p__57180;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57181,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57178){
var G__57179 = cljs.core.first(seq57178);
var seq57178__$1 = cljs.core.next(seq57178);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57179,seq57178__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57184_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57184_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57186_57259 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57187_57260 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57188_57261 = true;
var _STAR_print_fn_STAR__temp_val__57189_57262 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57188_57261);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57189_57262);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57187_57260);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57186_57259);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57185_SHARP_){
return debux.common.util.prepend_bars(p1__57185_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__57209 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57209.cljs$core$IFn$_invoke$arity$1 ? fexpr__57209.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57209.call(null,f));
})())){
var G__57271 = cljs.core.next(opts__$1);
var G__57272 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57271;
acc = G__57272;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57210 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57210.cljs$core$IFn$_invoke$arity$1 ? fexpr__57210.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57210.call(null,f));
})())){
var G__57273 = cljs.core.nnext(opts__$1);
var G__57274 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57273;
acc = G__57274;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57275 = cljs.core.next(opts__$1);
var G__57276 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57275;
acc = G__57276;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57211){
var vec__57212 = p__57211;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57212,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57212,(1),null);
...
var G__57216 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57215 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57215.cljs$core$IFn$_invoke$arity$1 ? fexpr__57215.cljs$core$IFn$_invoke$arity$1(G__57216) : fexpr__57215.call(null,G__57216));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57220 = quoted_form;
var G__57221 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57220,G__57221) : debux.common.util.remove_d.call(null,G__57220,G__57221));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57222 = quoted_form;
var G__57223 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57222,G__57223) : debux.common.util.remove_d.call(null,G__57222,G__57223));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57224 = quoted_form;
var G__57225 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57224,G__57225) : debux.common.util.remove_d.call(null,G__57224,G__57225));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__57280__i < G__57280__a.length) {G__57280__a[G__57280__i] = arguments[G__57280__i + 0]; ++G__57280__i;}
  arg = new cljs.core.IndexedSeq(G__57280__a,0,null);
} 
...
var arg = cljs.core.seq(arglist__57281);
...
var G__57282 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57282;
continue;
} else {
...
var G__57283 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57283;
continue;
} else {
var G__57284 = clojure.zip.next(loc);
loc = G__57284;
continue;
