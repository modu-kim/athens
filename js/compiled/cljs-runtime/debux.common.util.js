 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57173,mapping){
...
var state = map__57174__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57174__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57174__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57174__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57171_SHARP_){
if((p1__57171_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57171_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57269 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57270 = clojure.zip.next(loc);
loc = G__57270;
continue;
}
}
...
var G__57295 = (i__4737__auto___57294 + (1));
i__4737__auto___57294 = G__57295;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57223){
var vec__57224 = p__57223;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57224,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57221){
var G__57222 = cljs.core.first(seq57221);
var seq57221__$1 = cljs.core.next(seq57221);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57222,seq57221__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57227_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57227_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57229_57298 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57230_57299 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57231_57300 = true;
var _STAR_print_fn_STAR__temp_val__57232_57301 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57231_57300);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57232_57301);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57230_57299);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57229_57298);
}
...
if(typeof f === 'number'){
var G__57302 = cljs.core.next(opts__$1);
var G__57303 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57302;
acc = G__57303;
continue;
} else {
...
var G__57305 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57304;
acc = G__57305;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57306 = cljs.core.nnext(opts__$1);
var G__57307 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57306;
acc = G__57307;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57308 = cljs.core.next(opts__$1);
var G__57309 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57308;
acc = G__57309;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57237 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57237.cljs$core$IFn$_invoke$arity$1 ? fexpr__57237.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57237.call(null,f));
})())){
var G__57310 = cljs.core.next(opts__$1);
var G__57311 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57310;
acc = G__57311;
continue;
} else {
...
var G__57312 = cljs.core.nnext(opts__$1);
var G__57313 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57312;
acc = G__57313;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57314 = cljs.core.next(opts__$1);
var G__57315 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57314;
acc = G__57315;
continue;
} else {
...
var G__57252 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57251 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57251.cljs$core$IFn$_invoke$arity$1 ? fexpr__57251.cljs$core$IFn$_invoke$arity$1(G__57252) : fexpr__57251.call(null,G__57252));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57258 = quoted_form;
var G__57259 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57258,G__57259) : debux.common.util.remove_d.call(null,G__57258,G__57259));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57262 = quoted_form;
var G__57263 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57262,G__57263) : debux.common.util.remove_d.call(null,G__57262,G__57263));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57264 = quoted_form;
var G__57265 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57264,G__57265) : debux.common.util.remove_d.call(null,G__57264,G__57265));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__57319__i < G__57319__a.length) {G__57319__a[G__57319__i] = arguments[G__57319__i + 0]; ++G__57319__i;}
  arg = new cljs.core.IndexedSeq(G__57319__a,0,null);
} 
...
var arg = cljs.core.seq(arglist__57320);
...
var G__57321 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57321;
continue;
} else {
...
var G__57322 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57322;
continue;
} else {
var G__57323 = clojure.zip.next(loc);
loc = G__57323;
continue;
