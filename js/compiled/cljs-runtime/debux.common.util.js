...
return (!(cljs.core.contains_QMARK_(result,p1__57099_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57098_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57098_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57100_SHARP_){
return (((p1__57100_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57100_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57103,mapping){
...
var state = map__57104__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57104__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57104__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57104__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57101_SHARP_){
if((p1__57101_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57101_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57195 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57196 = clojure.zip.next(loc);
loc = G__57196;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57115){
var vec__57116 = p__57115;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57116,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57112){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57119_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57119_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57122_57231 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57123_57232 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57124_57233 = true;
var _STAR_print_fn_STAR__temp_val__57125_57234 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57124_57233);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57125_57234);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57123_57232);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57122_57231);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57120_SHARP_){
return debux.common.util.prepend_bars(p1__57120_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57235 = cljs.core.next(opts__$1);
var G__57236 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57235;
acc = G__57236;
continue;
} else {
if(typeof f === 'string'){
var G__57237 = cljs.core.next(opts__$1);
var G__57238 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57237;
acc = G__57238;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57239 = cljs.core.nnext(opts__$1);
var G__57240 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57239;
acc = G__57240;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57241 = cljs.core.next(opts__$1);
var G__57242 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57241;
acc = G__57242;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57141 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57141.cljs$core$IFn$_invoke$arity$1 ? fexpr__57141.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57141.call(null,f));
})())){
var G__57243 = cljs.core.next(opts__$1);
var G__57244 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57243;
acc = G__57244;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57142 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57142.cljs$core$IFn$_invoke$arity$1 ? fexpr__57142.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57142.call(null,f));
})())){
var G__57245 = cljs.core.nnext(opts__$1);
var G__57246 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57245;
acc = G__57246;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57249 = cljs.core.next(opts__$1);
var G__57250 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57249;
acc = G__57250;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57143){
var vec__57144 = p__57143;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57144,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57144,(1),null);
...
var G__57148 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57147 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57147.cljs$core$IFn$_invoke$arity$1 ? fexpr__57147.cljs$core$IFn$_invoke$arity$1(G__57148) : fexpr__57147.call(null,G__57148));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57150 = quoted_form;
var G__57151 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57150,G__57151) : debux.common.util.remove_d.call(null,G__57150,G__57151));
...
return (function() { 
var G__57251__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57174 = quoted_form;
var G__57175 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57174,G__57175) : debux.common.util.remove_d.call(null,G__57174,G__57175));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__57256__i = 0, G__57256__a = new Array(arguments.length -  0);
while (G__57256__i < G__57256__a.length) {G__57256__a[G__57256__i] = arguments[G__57256__i + 0]; ++G__57256__i;}
  arg = new cljs.core.IndexedSeq(G__57256__a,0,null);
} 
return G__57251__delegate.call(this,arg);};
G__57251.cljs$lang$maxFixedArity = 0;
G__57251.cljs$lang$applyTo = (function (arglist__57257){
var arg = cljs.core.seq(arglist__57257);
return G__57251__delegate(arg);
});
...
var G__57275 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57275;
continue;
} else {
...
var G__57280 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57280;
continue;
} else {
var G__57281 = clojure.zip.next(loc);
loc = G__57281;
continue;
