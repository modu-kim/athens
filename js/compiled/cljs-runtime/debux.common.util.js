...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57233_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57233_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57232_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57232_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57234_SHARP_){
return (((p1__57234_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57234_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57239,mapping){
...
var state = map__57240__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57240__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57240__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57240__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57237_SHARP_){
if((p1__57237_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57237_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57302 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57303 = clojure.zip.next(loc);
loc = G__57303;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57269){
var vec__57270 = p__57269;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57270,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57265){
var G__57266 = cljs.core.first(seq57265);
var seq57265__$1 = cljs.core.next(seq57265);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57266,seq57265__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57273_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57273_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57275_57309 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57276_57310 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57277_57311 = true;
var _STAR_print_fn_STAR__temp_val__57278_57312 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57277_57311);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57278_57312);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57276_57310);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57275_57309);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57274_SHARP_){
return debux.common.util.prepend_bars(p1__57274_SHARP_,indent_level);
...
var G__57314 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57313;
acc = G__57314;
continue;
} else {
...
var G__57316 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57315;
acc = G__57316;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57317 = cljs.core.nnext(opts__$1);
var G__57318 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57317;
acc = G__57318;
continue;
} else {
...
var G__57320 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57319;
acc = G__57320;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57281 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57281.cljs$core$IFn$_invoke$arity$1 ? fexpr__57281.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57281.call(null,f));
})())){
var G__57321 = cljs.core.next(opts__$1);
var G__57322 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57321;
acc = G__57322;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57282 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57282.cljs$core$IFn$_invoke$arity$1 ? fexpr__57282.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57282.call(null,f));
})())){
var G__57323 = cljs.core.nnext(opts__$1);
var G__57324 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57323;
acc = G__57324;
continue;
} else {
...
var G__57326 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57325;
acc = G__57326;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57283){
var vec__57284 = p__57283;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57284,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57284,(1),null);
...
var G__57288 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57287 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57287.cljs$core$IFn$_invoke$arity$1 ? fexpr__57287.cljs$core$IFn$_invoke$arity$1(G__57288) : fexpr__57287.call(null,G__57288));
});
...
return (function() { 
var G__57327__delegate = function (arg){
...
return G__57327__delegate.call(this,arg);};
G__57327.cljs$lang$maxFixedArity = 0;
G__57327.cljs$lang$applyTo = (function (arglist__57329){
var arg = cljs.core.seq(arglist__57329);
return G__57327__delegate(arg);
});
...
var G__57330 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57330;
continue;
} else {
...
var G__57331 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57331;
continue;
} else {
var G__57332 = clojure.zip.next(loc);
loc = G__57332;
continue;
