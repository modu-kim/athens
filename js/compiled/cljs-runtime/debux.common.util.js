...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57101_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57101_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57100_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57100_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57102_SHARP_){
return (((p1__57102_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57102_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57109,mapping){
var map__57110 = p__57109;
var map__57110__$1 = (((((!((map__57110 == null))))?(((((map__57110.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57110.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57110):map__57110);
var state = map__57110__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57110__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57110__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57110__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57107_SHARP_){
if((p1__57107_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57107_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57227 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57228 = clojure.zip.next(loc);
loc = G__57228;
continue;
}
}
...
var len__4736__auto___57256 = arguments.length;
var i__4737__auto___57257 = (0);
while(true){
if((i__4737__auto___57257 < len__4736__auto___57256)){
args__4742__auto__.push((arguments[i__4737__auto___57257]));

var G__57258 = (i__4737__auto___57257 + (1));
i__4737__auto___57257 = G__57258;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57130){
var vec__57131 = p__57130;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57131,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57128){
var G__57129 = cljs.core.first(seq57128);
var seq57128__$1 = cljs.core.next(seq57128);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57129,seq57128__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57142_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57142_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57149_57259 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57150_57260 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57151_57261 = true;
var _STAR_print_fn_STAR__temp_val__57152_57262 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57151_57261);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57152_57262);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57150_57260);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57149_57259);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57147_SHARP_){
return debux.common.util.prepend_bars(p1__57147_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57263 = cljs.core.next(opts__$1);
var G__57264 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57263;
acc = G__57264;
continue;
} else {
if(typeof f === 'string'){
var G__57265 = cljs.core.next(opts__$1);
var G__57266 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57265;
acc = G__57266;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57267 = cljs.core.nnext(opts__$1);
var G__57268 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57267;
acc = G__57268;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57269 = cljs.core.next(opts__$1);
var G__57270 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57269;
acc = G__57270;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57180 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57180.cljs$core$IFn$_invoke$arity$1 ? fexpr__57180.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57180.call(null,f));
})())){
var G__57273 = cljs.core.next(opts__$1);
var G__57274 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57273;
acc = G__57274;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57181 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57181.cljs$core$IFn$_invoke$arity$1 ? fexpr__57181.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57181.call(null,f));
})())){
var G__57275 = cljs.core.nnext(opts__$1);
var G__57276 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57275;
acc = G__57276;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57277 = cljs.core.next(opts__$1);
var G__57278 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57277;
acc = G__57278;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57182){
var vec__57183 = p__57182;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57183,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57183,(1),null);
...
var G__57187 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57186 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57186.cljs$core$IFn$_invoke$arity$1 ? fexpr__57186.cljs$core$IFn$_invoke$arity$1(G__57187) : fexpr__57186.call(null,G__57187));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57189 = quoted_form;
var G__57190 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57189,G__57190) : debux.common.util.remove_d.call(null,G__57189,G__57190));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57191 = quoted_form;
var G__57192 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57191,G__57192) : debux.common.util.remove_d.call(null,G__57191,G__57192));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57279__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57193 = quoted_form;
var G__57194 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57193,G__57194) : debux.common.util.remove_d.call(null,G__57193,G__57194));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__57288__i = 0, G__57288__a = new Array(arguments.length -  0);
while (G__57288__i < G__57288__a.length) {G__57288__a[G__57288__i] = arguments[G__57288__i + 0]; ++G__57288__i;}
  arg = new cljs.core.IndexedSeq(G__57288__a,0,null);
} 
return G__57279__delegate.call(this,arg);};
G__57279.cljs$lang$maxFixedArity = 0;
G__57279.cljs$lang$applyTo = (function (arglist__57289){
var arg = cljs.core.seq(arglist__57289);
return G__57279__delegate(arg);
});
...
var G__57294 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57294;
continue;
} else {
...
var G__57295 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57295;
continue;
} else {
var G__57296 = clojure.zip.next(loc);
loc = G__57296;
continue;
