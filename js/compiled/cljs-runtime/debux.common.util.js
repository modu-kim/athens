 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57237,mapping){
var map__57238 = p__57237;
...
var state = map__57238__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57238__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57238__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57238__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57235_SHARP_){
if((p1__57235_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57235_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57300 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57301 = clojure.zip.next(loc);
loc = G__57301;
continue;
}
}
...
var G__57306 = (i__4737__auto___57305 + (1));
i__4737__auto___57305 = G__57306;
continue;
} else {
}
break;
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57271_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57271_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57273_57307 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57274_57308 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57275_57309 = true;
var _STAR_print_fn_STAR__temp_val__57276_57310 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57275_57309);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57276_57310);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57274_57308);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57273_57307);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57272_SHARP_){
return debux.common.util.prepend_bars(p1__57272_SHARP_,indent_level);
...
var G__57312 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57311;
acc = G__57312;
continue;
} else {
...
var G__57314 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57313;
acc = G__57314;
continue;
} else {
...
var G__57316 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57315;
acc = G__57316;
continue;
} else {
...
var G__57318 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57317;
acc = G__57318;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57279 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
var G__57320 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57319;
acc = G__57320;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57280 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57280.cljs$core$IFn$_invoke$arity$1 ? fexpr__57280.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57280.call(null,f));
})())){
var G__57321 = cljs.core.nnext(opts__$1);
var G__57322 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57321;
acc = G__57322;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57323 = cljs.core.next(opts__$1);
var G__57324 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57323;
acc = G__57324;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57281){
var vec__57282 = p__57281;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57282,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57282,(1),null);
...
var G__57286 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57285 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57285.cljs$core$IFn$_invoke$arity$1 ? fexpr__57285.cljs$core$IFn$_invoke$arity$1(G__57286) : fexpr__57285.call(null,G__57286));
});
...
return (function() { 
var G__57325__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57292 = quoted_form;
var G__57293 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57292,G__57293) : debux.common.util.remove_d.call(null,G__57292,G__57293));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57325 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57326__i = 0, G__57326__a = new Array(arguments.length -  0);
while (G__57326__i < G__57326__a.length) {G__57326__a[G__57326__i] = arguments[G__57326__i + 0]; ++G__57326__i;}
  arg = new cljs.core.IndexedSeq(G__57326__a,0,null);
} 
return G__57325__delegate.call(this,arg);};
G__57325.cljs$lang$maxFixedArity = 0;
G__57325.cljs$lang$applyTo = (function (arglist__57327){
var arg = cljs.core.seq(arglist__57327);
return G__57325__delegate(arg);
});
G__57325.cljs$core$IFn$_invoke$arity$variadic = G__57325__delegate;
return G__57325;
})()
;
});
...
var G__57328 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57328;
continue;
} else {
...
var G__57329 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57329;
continue;
} else {
var G__57330 = clojure.zip.next(loc);
loc = G__57330;
continue;
