...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57097_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57097_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57096_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57096_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57098_SHARP_){
return (((p1__57098_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57098_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57101,mapping){
...
var state = map__57102__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57102__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57102__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57102__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57099_SHARP_){
if((p1__57099_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57099_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57171 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57173 = clojure.zip.next(loc);
loc = G__57173;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57111){
var vec__57112 = p__57111;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57112,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57109){
var G__57110 = cljs.core.first(seq57109);
var seq57109__$1 = cljs.core.next(seq57109);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57110,seq57109__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57115_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57115_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57117_57204 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57118_57205 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57119_57206 = true;
var _STAR_print_fn_STAR__temp_val__57120_57207 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57119_57206);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57120_57207);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57118_57205);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57117_57204);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57116_SHARP_){
return debux.common.util.prepend_bars(p1__57116_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57208 = cljs.core.next(opts__$1);
var G__57209 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57208;
acc = G__57209;
continue;
} else {
if(typeof f === 'string'){
var G__57210 = cljs.core.next(opts__$1);
var G__57211 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57210;
acc = G__57211;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57212 = cljs.core.nnext(opts__$1);
var G__57213 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57212;
acc = G__57213;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57214 = cljs.core.next(opts__$1);
var G__57215 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57214;
acc = G__57215;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57128 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57128.cljs$core$IFn$_invoke$arity$1 ? fexpr__57128.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57128.call(null,f));
})())){
var G__57216 = cljs.core.next(opts__$1);
var G__57217 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57216;
acc = G__57217;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57129 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57129.cljs$core$IFn$_invoke$arity$1 ? fexpr__57129.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57129.call(null,f));
})())){
var G__57218 = cljs.core.nnext(opts__$1);
var G__57219 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57218;
acc = G__57219;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57220 = cljs.core.next(opts__$1);
var G__57221 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57220;
acc = G__57221;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57130){
var vec__57131 = p__57130;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57131,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57131,(1),null);
...
var G__57135 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57134 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57134.cljs$core$IFn$_invoke$arity$1 ? fexpr__57134.cljs$core$IFn$_invoke$arity$1(G__57135) : fexpr__57134.call(null,G__57135));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57138 = quoted_form;
var G__57139 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57138,G__57139) : debux.common.util.remove_d.call(null,G__57138,G__57139));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57140 = quoted_form;
var G__57141 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57140,G__57141) : debux.common.util.remove_d.call(null,G__57140,G__57141));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57234__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57147 = quoted_form;
var G__57148 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57147,G__57148) : debux.common.util.remove_d.call(null,G__57147,G__57148));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57234 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57235__i = 0, G__57235__a = new Array(arguments.length -  0);
while (G__57235__i < G__57235__a.length) {G__57235__a[G__57235__i] = arguments[G__57235__i + 0]; ++G__57235__i;}
  arg = new cljs.core.IndexedSeq(G__57235__a,0,null);
} 
return G__57234__delegate.call(this,arg);};
G__57234.cljs$lang$maxFixedArity = 0;
G__57234.cljs$lang$applyTo = (function (arglist__57236){
var arg = cljs.core.seq(arglist__57236);
return G__57234__delegate(arg);
});
G__57234.cljs$core$IFn$_invoke$arity$variadic = G__57234__delegate;
return G__57234;
})()
;
});
...
var G__57237 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57237;
continue;
} else {
...
var G__57244 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57244;
continue;
} else {
