...
var G__61810__delegate = function (contents){
...
var G__61810 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__61811__i = 0, G__61811__a = new Array(arguments.length -  0);
while (G__61811__i < G__61811__a.length) {G__61811__a[G__61811__i] = arguments[G__61811__i + 0]; ++G__61811__i;}
  contents = new cljs.core.IndexedSeq(G__61811__a,0,null);
} 
return G__61810__delegate.call(this,contents);};
G__61810.cljs$lang$maxFixedArity = 0;
G__61810.cljs$lang$applyTo = (function (arglist__61812){
var contents = cljs.core.seq(arglist__61812);
return G__61810__delegate(contents);
});
G__61810.cljs$core$IFn$_invoke$arity$variadic = G__61810__delegate;
return G__61810;
})()
,(function (p__61804){
...
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61805__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
var G__61813__delegate = function (contents){
...
while (G__61814__i < G__61814__a.length) {G__61814__a[G__61814__i] = arguments[G__61814__i + 0]; ++G__61814__i;}
  contents = new cljs.core.IndexedSeq(G__61814__a,0,null);
} 
return G__61813__delegate.call(this,contents);};
G__61813.cljs$lang$maxFixedArity = 0;
G__61813.cljs$lang$applyTo = (function (arglist__61815){
var contents = cljs.core.seq(arglist__61815);
return G__61813__delegate(contents);
});
G__61813.cljs$core$IFn$_invoke$arity$variadic = G__61813__delegate;
return G__61813;
})()
,(function() { 
var G__61816__delegate = function (title_coll){
return athens.parse_renderer.render_page_link(title_coll);
};
var G__61816 = function (var_args){
var title_coll = null;
if (arguments.length > 0) {
var G__61817__i = 0, G__61817__a = new Array(arguments.length -  0);
while (G__61817__i < G__61817__a.length) {G__61817__a[G__61817__i] = arguments[G__61817__i + 0]; ++G__61817__i;}
  title_coll = new cljs.core.IndexedSeq(G__61817__a,0,null);
} 
return G__61816__delegate.call(this,title_coll);};
G__61816.cljs$lang$maxFixedArity = 0;
G__61816.cljs$lang$applyTo = (function (arglist__61818){
var title_coll = cljs.core.seq(arglist__61818);
return G__61816__delegate(title_coll);
});
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.parse_renderer.block_ref,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"block-ref"], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"contents",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__61801_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(ref_uid,p1__61801_SHARP_);
...
var G__61819__delegate = function (title_coll){
var node = athens.parse_renderer.pull_node_from_string(title_coll);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.parse_renderer.hashtag,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"hashtag",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__61800_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(node)),p1__61800_SHARP_);
...
var G__61819 = function (var_args){
var title_coll = null;
if (arguments.length > 0) {
var G__61820__i = 0, G__61820__a = new Array(arguments.length -  0);
while (G__61820__i < G__61820__a.length) {G__61820__a[G__61820__i] = arguments[G__61820__i + 0]; ++G__61820__i;}
  title_coll = new cljs.core.IndexedSeq(G__61820__a,0,null);
} 
return G__61819__delegate.call(this,title_coll);};
G__61819.cljs$lang$maxFixedArity = 0;
G__61819.cljs$lang$applyTo = (function (arglist__61821){
var title_coll = cljs.core.seq(arglist__61821);
return G__61819__delegate(title_coll);
});
G__61819.cljs$core$IFn$_invoke$arity$variadic = G__61819__delegate;
return G__61819;
})()
,(function (p__61807,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61808__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__61803 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__61802,G__61803) : instaparse.core.transform.call(null,G__61802,G__61803));
});
/**
