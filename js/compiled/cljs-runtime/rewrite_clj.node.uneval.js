...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29436,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29436,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29442){
var vec__29443 = p__29442;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29435){
var self__ = this;
var G__29435__$1 = this;
return (new cljs.core.RecordIter((0),G__29435__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29437,other29438){
var self__ = this;
var this29437__$1 = this;
return (((!((other29438 == null)))) && ((this29437__$1.constructor === other29438.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29437__$1.children,other29438.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29437__$1.__extmap,other29438.__extmap)));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29435){
var self__ = this;
...
return (new rewrite_clj.node.uneval.UnevalNode(G__29435,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29435),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29435){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__29435,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__29439){
var extmap__4419__auto__ = (function (){var G__29450 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__29439,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__29439)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29450);
} else {
return G__29450;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29439),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__29452 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29452;
continue;
}
break;
