...
var G__29805 = (function (){var G__29790 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [node], null);
...
return (rewrite_clj.node.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.tag.cljs$core$IFn$_invoke$arity$1(G__29792__$1) : rewrite_clj.node.tag.call(null,G__29792__$1));
}
});
/**
...
return (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(G__29794__$1) : rewrite_clj.node.sexpr.call(null,G__29794__$1));
}
});
/**
...
return (rewrite_clj.node.child_sexprs.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.child_sexprs.cljs$core$IFn$_invoke$arity$1(G__29796__$1) : rewrite_clj.node.child_sexprs.call(null,G__29796__$1));
}
});
/**
...
var G__29800 = s;
var G__29800__$1 = (((G__29800 == null))?null:rewrite_clj.parser.parse_string_all(G__29800));
if((G__29800__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn(G__29800__$1);
}
});
/**
