...
var map__61689 = athens.util.destruct_key_down(e);
...
var key_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61689__$1,new cljs.core.Keyword(null,"key-code","key-code",-1732114304));
var ctrl = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61689__$1,new cljs.core.Keyword(null,"ctrl","ctrl",361402094));
var meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61689__$1,new cljs.core.Keyword(null,"meta","meta",1499536964));
var shift = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61689__$1,new cljs.core.Keyword(null,"shift","shift",997140064));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61689__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
var editing_uid = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null)));
if(cljs.core.truth_(athens.util.shortcut_key_QMARK_(meta,ctrl))){
var pred__61691 = cljs.core._EQ_;
var expr__61692 = key_code;
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.S,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.S,expr__61692)))){
...
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.K,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.K,expr__61692)))){
...
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.G,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.G,expr__61692)))){
...
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.Z,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.Z,expr__61692)))){
...
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.BACKSLASH,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.BACKSLASH,expr__61692)))){
if(cljs.core.truth_(shift)){
...
if(cljs.core.truth_((pred__61691.cljs$core$IFn$_invoke$arity$2 ? pred__61691.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.H,expr__61692) : pred__61691.call(null,goog.events.KeyCodes.H,expr__61692)))){
...
var pred__61694 = cljs.core._EQ_;
var expr__61695 = key_code;
if(cljs.core.truth_((pred__61694.cljs$core$IFn$_invoke$arity$2 ? pred__61694.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.LEFT,expr__61695) : pred__61694.call(null,goog.events.KeyCodes.LEFT,expr__61695)))){
if((editing_uid == null)){
...
if(cljs.core.truth_((pred__61694.cljs$core$IFn$_invoke$arity$2 ? pred__61694.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.RIGHT,expr__61695) : pred__61694.call(null,goog.events.KeyCodes.RIGHT,expr__61695)))){
if((editing_uid == null)){
...
if(cljs.core.truth_((pred__61694.cljs$core$IFn$_invoke$arity$2 ? pred__61694.cljs$core$IFn$_invoke$arity$2(goog.events.KeyCodes.D,expr__61695) : pred__61694.call(null,goog.events.KeyCodes.D,expr__61695)))){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61698__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61698__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
...
var walk_children = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61697_SHARP_){
var G__61700 = (depth + (1));
var G__61701 = p1__61697_SHARP_;
return (athens.listeners.walk_str.cljs$core$IFn$_invoke$arity$2 ? athens.listeners.walk_str.cljs$core$IFn$_invoke$arity$2(G__61700,G__61701) : athens.listeners.walk_str.call(null,G__61700,G__61701));
}),children));
...
var copy_data = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61703_SHARP_){
return athens.listeners.walk_str((0),p1__61703_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61702_SHARP_){
return athens.db.get_block_document(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),p1__61702_SHARP_], null));
}),uids)));
e.preventDefault();
