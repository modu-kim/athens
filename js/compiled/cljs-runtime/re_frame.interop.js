...
return [(function (){var pred__31910 = cljs.core.instance_QMARK_;
var expr__31911 = reactive_val;
if(cljs.core.truth_((pred__31910.cljs$core$IFn$_invoke$arity$2 ? pred__31910.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__31911) : pred__31910.call(null,reagent.ratom.RAtom,expr__31911)))){
return "ra";
} else {
if(cljs.core.truth_((pred__31910.cljs$core$IFn$_invoke$arity$2 ? pred__31910.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__31911) : pred__31910.call(null,reagent.ratom.RCursor,expr__31911)))){
return "rc";
} else {
if(cljs.core.truth_((pred__31910.cljs$core$IFn$_invoke$arity$2 ? pred__31910.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__31911) : pred__31910.call(null,reagent.ratom.Reaction,expr__31911)))){
return "rx";
} else {
if(cljs.core.truth_((pred__31910.cljs$core$IFn$_invoke$arity$2 ? pred__31910.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__31911) : pred__31910.call(null,reagent.ratom.Track,expr__31911)))){
return "tr";
} else {
return "other";
}
