...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__61144){
var vec__61145 = p__61144;
var seq__61146 = cljs.core.seq(vec__61145);
var first__61147 = cljs.core.first(seq__61146);
var seq__61146__$1 = cljs.core.next(seq__61146);
var ___$1 = first__61147;
var route = seq__61146__$1;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__61148,p__61149){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61150__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61151 = p__61149;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61151,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61151,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__61155,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61156__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
var result__57809__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__57808__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__57809__auto__ = reitit.frontend.easy.push_state;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__57809__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__57809__auto__;
})(),(function (){var opts__57808__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__57809__auto__ = route;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__57809__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"route","route",1970422836,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__57809__auto__;
})());
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__57809__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"apply","apply",-1334050276,null),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Symbol(null,"route","route",1970422836,null)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__57809__auto__;
}catch (e61158){var e = e61158;
throw e;
}}):(function (route){
