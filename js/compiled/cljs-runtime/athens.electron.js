...
var seq__55647 = cljs.core.seq(imgs);
var chunk__55648 = null;
var count__55649 = (0);
var i__55650 = (0);
while(true){
if((i__55650 < count__55649)){
var vec__55664 = chunk__55648.cljs$core$IIndexed$_nth$arity$2(null,i__55650);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55664,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55664,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55734 = seq__55647;
var G__55735 = chunk__55648;
var G__55736 = count__55649;
var G__55737 = (i__55650 + (1));
seq__55647 = G__55734;
chunk__55648 = G__55735;
count__55649 = G__55736;
i__55650 = G__55737;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__55647);
if(temp__5735__auto__){
var seq__55647__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__55647__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__55647__$1);
var G__55738 = cljs.core.chunk_rest(seq__55647__$1);
var G__55739 = c__4556__auto__;
var G__55740 = cljs.core.count(c__4556__auto__);
var G__55741 = (0);
seq__55647 = G__55738;
chunk__55648 = G__55739;
count__55649 = G__55740;
i__55650 = G__55741;
continue;
} else {
var vec__55670 = cljs.core.first(seq__55647__$1);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55670,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55670,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55742 = cljs.core.next(seq__55647__$1);
var G__55743 = null;
var G__55744 = (0);
var G__55745 = (0);
seq__55647 = G__55742;
chunk__55648 = G__55743;
count__55649 = G__55744;
i__55650 = G__55745;
continue;
}
} else {
...
var map__55694 = athens.db.get_block(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),target_uid], null));
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55694__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
})():(function (){var index = (function (){var G__55697 = drag_target;
var G__55697__$1 = (((G__55697 instanceof cljs.core.Keyword))?G__55697.fqn:null);
switch (G__55697__$1) {
case "above":
return (order - (1));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55697__$1)].join('')));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","open-dialog","fs/open-dialog",-1381619732),(function (p__55699,_){
var map__55700 = p__55699;
var map__55700__$1 = (((((!((map__55700 == null))))?(((((map__55700.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55700.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55700):map__55700);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55700__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","get-db-filepath","local-storage/get-db-filepath",-2015649354),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"db/filepath")], null),(function (p__55702,_){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__55705,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55706__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","watch","fs/watch",380976938),(function (_,p__55708){
var vec__55709 = p__55708;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55709,(0),null);
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55709,(1),null);
var dirpath_55748 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_55748,(function (_event,filename){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","update-mtime","db/update-mtime",768440096),(function (db,p__55712){
var vec__55713 = p__55712;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55713,(0),null);
var mtime1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55713,(1),null);
var map__55716 = db;
...
var filepath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55716__$1,new cljs.core.Keyword("db","filepath","db/filepath",1097485287));
...
var blocks_orig_55751 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55727){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55728__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
...
}),blocks_with_plain_links_55750);
var blocks_temp_55752 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55730){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55731__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_temp_55752], null));

re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_orig_55751], null));
...
var schema_version_55753 = cljs.core.second(cljs.core.first(schemas));
var G__55733_55754 = schema_version_55753;
switch (G__55733_55754) {
case (1):
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([["Schema version ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55753)].join('')], 0));

break;
default:
alert(Error(["No matching case clause for schema version: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55753)].join('')));
