...
var seq__55646 = cljs.core.seq(imgs);
var chunk__55647 = null;
var count__55648 = (0);
var i__55649 = (0);
while(true){
if((i__55649 < count__55648)){
var vec__55656 = chunk__55647.cljs$core$IIndexed$_nth$arity$2(null,i__55649);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55737 = seq__55646;
var G__55738 = chunk__55647;
var G__55739 = count__55648;
var G__55740 = (i__55649 + (1));
seq__55646 = G__55737;
chunk__55647 = G__55738;
count__55648 = G__55739;
i__55649 = G__55740;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__55646);
if(temp__5735__auto__){
var seq__55646__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__55646__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__55646__$1);
var G__55741 = cljs.core.chunk_rest(seq__55646__$1);
var G__55742 = c__4556__auto__;
var G__55743 = cljs.core.count(c__4556__auto__);
var G__55744 = (0);
seq__55646 = G__55741;
chunk__55647 = G__55742;
count__55648 = G__55743;
i__55649 = G__55744;
continue;
} else {
var vec__55659 = cljs.core.first(seq__55646__$1);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55659,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55659,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55745 = cljs.core.next(seq__55646__$1);
var G__55746 = null;
var G__55747 = (0);
var G__55748 = (0);
seq__55646 = G__55745;
chunk__55647 = G__55746;
count__55648 = G__55747;
i__55649 = G__55748;
continue;
}
} else {
...
var map__55677 = athens.db.get_block(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),target_uid], null));
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55677__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
})():(function (){var index = (function (){var G__55680 = drag_target;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55680__$1)].join('')));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","open-dialog","fs/open-dialog",-1381619732),(function (p__55683,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55684__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","get-db-filepath","local-storage/get-db-filepath",-2015649354),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"db/filepath")], null),(function (p__55689,_){
var map__55691 = p__55689;
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55691__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__55695,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55696__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","watch","fs/watch",380976938),(function (_,p__55706){
var vec__55707 = p__55706;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55707,(0),null);
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55707,(1),null);
var dirpath_55751 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_55751,(function (_event,filename){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","update-mtime","db/update-mtime",768440096),(function (db,p__55711){
var vec__55712 = p__55711;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55712,(0),null);
var mtime1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55712,(1),null);
var map__55715 = db;
...
var filepath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55715__$1,new cljs.core.Keyword("db","filepath","db/filepath",1097485287));
...
var blocks_orig_55754 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55726){
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55727__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55727__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
...
}),blocks_with_plain_links_55753);
var blocks_temp_55755 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55729){
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_temp_55755], null));

re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_orig_55754], null));
...
var schema_version_55756 = cljs.core.second(cljs.core.first(schemas));
var G__55732_55757 = schema_version_55756;
switch (G__55732_55757) {
case (1):
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([["Schema version ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55756)].join('')], 0));

break;
default:
alert(Error(["No matching case clause for schema version: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55756)].join('')));
...
re_frame.core.reg_fx(new cljs.core.Keyword("fs","write!","fs/write!",-1029545496),(function (p__55733){
var vec__55734 = p__55733;
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55734,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55734,(1),null);
