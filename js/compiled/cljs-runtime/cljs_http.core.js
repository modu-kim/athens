...
var G__51995_52093 = xhr;
G__51995_52093.setProgressEventsEnabled(true);

G__51995_52093.listen(goog.net.EventType.UPLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_52090,new cljs.core.Keyword(null,"upload","upload",-255769218)));

G__51995_52093.listen(goog.net.EventType.DOWNLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_52090,new cljs.core.Keyword(null,"download","download",-300081668)));
...
if(cljs.core.truth_(cancel)){
var c__50417__auto___52094 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__50418__auto__ = (function (){var switch__50381__auto__ = (function (state_52010){
var state_val_52011 = (state_52010[(1)]);
if((state_val_52011 === (1))){
var state_52010__$1 = state_52010;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_52010__$1,(2),cancel);
} else {
if((state_val_52011 === (2))){
var inst_52000 = (state_52010[(2)]);
var inst_52001 = xhr.isComplete();
var inst_52002 = cljs.core.not(inst_52001);
var state_52010__$1 = (function (){var statearr_52016 = state_52010;
(statearr_52016[(7)] = inst_52000);

return statearr_52016;
})();
if(inst_52002){
var statearr_52017_52097 = state_52010__$1;
(statearr_52017_52097[(1)] = (3));

} else {
var statearr_52018_52098 = state_52010__$1;
(statearr_52018_52098[(1)] = (4));

}

return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52011 === (3))){
var inst_52004 = xhr.abort();
var state_52010__$1 = state_52010;
var statearr_52019_52101 = state_52010__$1;
(statearr_52019_52101[(2)] = inst_52004);

(statearr_52019_52101[(1)] = (5));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52011 === (4))){
var state_52010__$1 = state_52010;
var statearr_52022_52102 = state_52010__$1;
(statearr_52022_52102[(2)] = null);

(statearr_52022_52102[(1)] = (5));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52011 === (5))){
var inst_52007 = (state_52010[(2)]);
var state_52010__$1 = state_52010;
return cljs.core.async.impl.ioc_helpers.return_chan(state_52010__$1,inst_52007);
} else {
return null;
}
}
...
var cljs_http$core$xhr_$_state_machine__50382__auto____1 = (function (state_52010){
while(true){
var ret_value__50383__auto__ = (function (){try{while(true){
var result__50384__auto__ = switch__50381__auto__(state_52010);
...
var statearr_52026_52105 = state_52010;
(statearr_52026_52105[(2)] = ex__50385__auto__);


if(cljs.core.seq((state_52010[(4)]))){
var statearr_52027_52106 = state_52010;
(statearr_52027_52106[(1)] = cljs.core.first((state_52010[(4)])));
...
var G__52108 = state_52010;
state_52010 = G__52108;
continue;
} else {
...
cljs_http$core$xhr_$_state_machine__50382__auto__ = function(state_52010){
switch(arguments.length){
case 0:
return cljs_http$core$xhr_$_state_machine__50382__auto____0.call(this);
case 1:
return cljs_http$core$xhr_$_state_machine__50382__auto____1.call(this,state_52010);
}
...
(statearr_52029[(6)] = c__50417__auto___52094);
...
var req_52115 = jsonp.send(null,(function cljs_http$core$jsonp_$_success_callback(data){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_http.core.pending_requests,cljs.core.assoc,channel,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"jsonp","jsonp",226119588),jsonp,new cljs.core.Keyword(null,"request","request",1772954723),req_52115], null));

if(cljs.core.truth_(cancel)){
var c__50417__auto___52119 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__50418__auto__ = (function (){var switch__50381__auto__ = (function (state_52047){
var state_val_52048 = (state_52047[(1)]);
if((state_val_52048 === (1))){
var state_52047__$1 = state_52047;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_52047__$1,(2),cancel);
} else {
if((state_val_52048 === (2))){
var inst_52044 = (state_52047[(2)]);
var inst_52045 = jsonp.cancel(req_52115);
var state_52047__$1 = (function (){var statearr_52054 = state_52047;
...
var cljs_http$core$jsonp_$_state_machine__50382__auto____1 = (function (state_52047){
while(true){
var ret_value__50383__auto__ = (function (){try{while(true){
var result__50384__auto__ = switch__50381__auto__(state_52047);
if(cljs.core.keyword_identical_QMARK_(result__50384__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
continue;
} else {
return result__50384__auto__;
...
}catch (e52057){var ex__50385__auto__ = e52057;
var statearr_52059_52123 = state_52047;
(statearr_52059_52123[(2)] = ex__50385__auto__);


if(cljs.core.seq((state_52047[(4)]))){
var statearr_52060_52124 = state_52047;
(statearr_52060_52124[(1)] = cljs.core.first((state_52047[(4)])));
...
if(cljs.core.keyword_identical_QMARK_(ret_value__50383__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__52125 = state_52047;
state_52047 = G__52125;
continue;
} else {
return ret_value__50383__auto__;
}
...
cljs_http$core$jsonp_$_state_machine__50382__auto__ = function(state_52047){
switch(arguments.length){
case 0:
return cljs_http$core$jsonp_$_state_machine__50382__auto____0.call(this);
case 1:
return cljs_http$core$jsonp_$_state_machine__50382__auto____1.call(this,state_52047);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var state__50419__auto__ = (function (){var statearr_52062 = f__50418__auto__();
(statearr_52062[(6)] = c__50417__auto___52119);
...
var request = map__52066__$1;
var request_method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52066__$1,new cljs.core.Keyword(null,"request-method","request-method",1764796830));
