...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48180,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__48184 = k48180;
var G__48184__$1 = (((G__48184 instanceof cljs.core.Keyword))?G__48184.fqn:null);
switch (G__48184__$1) {
case "index":
return self__.index;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48185){
var vec__48186 = p__48185;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48186,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48186,(1),null);
...
(instaparse.line_col.Cursor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48179){
var self__ = this;
var G__48179__$1 = this;
return (new cljs.core.RecordIter((0),G__48179__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48181,other48182){
var self__ = this;
var this48181__$1 = this;
return (((!((other48182 == null)))) && ((this48181__$1.constructor === other48182.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48181__$1.index,other48182.index)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48181__$1.line,other48182.line)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48181__$1.column,other48182.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48181__$1.__extmap,other48182.__extmap)));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48179){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48189 = cljs.core.keyword_identical_QMARK_;
var expr__48190 = k__4388__auto__;
if(cljs.core.truth_((pred__48189.cljs$core$IFn$_invoke$arity$2 ? pred__48189.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__48190) : pred__48189.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__48190)))){
return (new instaparse.line_col.Cursor(G__48179,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48189.cljs$core$IFn$_invoke$arity$2 ? pred__48189.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__48190) : pred__48189.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__48190)))){
return (new instaparse.line_col.Cursor(self__.index,G__48179,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48189.cljs$core$IFn$_invoke$arity$2 ? pred__48189.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__48190) : pred__48189.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__48190)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__48179,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48179),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48179){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__48179,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__48183){
var extmap__4419__auto__ = (function (){var G__48192 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48183,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__48183)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48192);
} else {
return G__48192;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__48183),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__48183),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__48183),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__48220 = (index + (1));
var G__48221 = line;
var G__48222 = (column + (1));
index = G__48220;
line = G__48221;
column = G__48222;
continue;
