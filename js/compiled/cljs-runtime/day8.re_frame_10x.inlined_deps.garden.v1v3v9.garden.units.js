 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$convert(p__25127,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25129__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25129__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__25143 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25143,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25143,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25143,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25160__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25161 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25161__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__25282__delegate = function (x,y,more){
...
var G__25282 = function (x,y,var_args){
var more = null;
...
return G__25282__delegate.call(this,x,y,more);};
G__25282.cljs$lang$maxFixedArity = 2;
...
return G__25282__delegate(x,y,more);
});
...
G__25286 = new cljs.core.IndexedSeq(G__25287__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25286);
}
...
var G__25299__delegate = function (x,y,more){
...
var G__25299 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
return G__25299__delegate.call(this,x,y,more);};
G__25299.cljs$lang$maxFixedArity = 2;
...
return G__25299__delegate(x,y,more);
});
...
G__25303 = new cljs.core.IndexedSeq(G__25304__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25303);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
G__25311 = new cljs.core.IndexedSeq(G__25312__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25311);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
