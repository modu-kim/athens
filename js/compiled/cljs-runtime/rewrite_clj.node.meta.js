...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29482,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29482,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__29488){
var vec__29489 = p__29488;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29489,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29489,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29483,other29484){
var self__ = this;
var this29483__$1 = this;
return (((!((other29484 == null)))) && ((this29483__$1.constructor === other29484.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29483__$1.tag,other29484.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29483__$1.prefix,other29484.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29483__$1.children,other29484.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29483__$1.__extmap,other29484.__extmap)));
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29481){
var self__ = this;
...
return (new rewrite_clj.node.meta.MetaNode(G__29481,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__29481,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__29481,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29481),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29481){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__29481,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__29486){
var extmap__4419__auto__ = (function (){var G__29503 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29486,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29486)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29503);
} else {
return G__29503;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29486),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__29486),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29486),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
