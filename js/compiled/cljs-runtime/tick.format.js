...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__42066 = goog.object.get(JSJodaLocale,"Locale");
if((G__42066 == null)){
return null;
} else {
return goog.object.get(G__42066,"US");
}
}catch (e42065){if((e42065 instanceof Error)){
var e = e42065;
return null;
} else {
throw e42065;
