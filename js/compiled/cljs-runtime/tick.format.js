...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__42080 = goog.object.get(JSJodaLocale,"Locale");
if((G__42080 == null)){
return null;
} else {
return goog.object.get(G__42080,"US");
}
}catch (e42077){if((e42077 instanceof Error)){
var e = e42077;
return null;
} else {
throw e42077;
