...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__42078 = goog.object.get(JSJodaLocale,"Locale");
if((G__42078 == null)){
return null;
} else {
return goog.object.get(G__42078,"US");
}
}catch (e42073){if((e42073 instanceof Error)){
var e = e42073;
return null;
} else {
throw e42073;
