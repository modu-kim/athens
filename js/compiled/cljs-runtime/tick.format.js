...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__42086 = goog.object.get(JSJodaLocale,"Locale");
if((G__42086 == null)){
return null;
} else {
return goog.object.get(G__42086,"US");
}
}catch (e42083){if((e42083 instanceof Error)){
var e = e42083;
return null;
} else {
throw e42083;
