...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__62298){
var vec__62299 = p__62298;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62299,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62299,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__62303,args){
var vec__62304 = p__62303;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62304,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62304,(1),null);
...
var vec__62307 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62307,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62307,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__62310,sym){
var map__62311 = p__62310;
...
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62311__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62311__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__62313,sym){
var map__62314 = p__62313;
var map__62314__$1 = (((((!((map__62314 == null))))?(((((map__62314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62314):map__62314);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62314__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62314__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
