...
var G__29881 = (function (){var G__29882 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29882) : f.call(null,G__29882));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__29881) : rewrite_clj.node.coerce.call(null,G__29881));
});
/**
...
var len__4736__auto___29894 = arguments.length;
var i__4737__auto___29895 = (0);
while(true){
if((i__4737__auto___29895 < len__4736__auto___29894)){
args__4742__auto__.push((arguments[i__4737__auto___29895]));

var G__29896 = (i__4737__auto___29895 + (1));
i__4737__auto___29895 = G__29896;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__29883_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__29883_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq29884){
var G__29885 = cljs.core.first(seq29884);
var seq29884__$1 = cljs.core.next(seq29884);
var G__29886 = cljs.core.first(seq29884__$1);
var seq29884__$2 = cljs.core.next(seq29884__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29885,G__29886,seq29884__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29887 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29887) : str_fn.call(null,G__29887));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29888 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29888) : str_fn.call(null,G__29888));
})()):null)));
...
var G__29891 = rewrite_clj.zip.base.tag(zloc);
var G__29891__$1 = (((G__29891 instanceof cljs.core.Keyword))?G__29891.fqn:null);
switch (G__29891__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29889_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29889_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__29890_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29890_SHARP_)].join('');
}));
}
}));
...
var G__29893 = rewrite_clj.zip.base.tag(zloc);
var G__29893__$1 = (((G__29893 instanceof cljs.core.Keyword))?G__29893.fqn:null);
switch (G__29893__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29892_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29892_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29893__$1)].join('')));
