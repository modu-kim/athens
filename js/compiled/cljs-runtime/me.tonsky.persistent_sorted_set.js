...
me.tonsky.persistent_sorted_set.level_shift = (cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36301_SHARP_){
return (((32) & (1 << p1__36301_SHARP_)) != 0);
...
var l__36220__auto___36383 = (splice_from - cut_from);
var n__4613__auto___36384 = l__36220__auto___36383;
var i__36221__auto___36385 = (0);
while(true){
if((i__36221__auto___36385 < n__4613__auto___36384)){
(new_arr[(i__36221__auto___36385 + (0))] = (arr[(i__36221__auto___36385 + cut_from)]));

var G__36386 = (i__36221__auto___36385 + (1));
i__36221__auto___36385 = G__36386;
continue;
} else {
}
break;
...
var me$tonsky$persistent_sorted_set$INode$node_disj$dyn_36438 = (function (_,cmp,key,root_QMARK_,left,right){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_disj$dyn_36438(_,cmp,key,root_QMARK_,left,right);
}
});
...
while(true){
if((level > (0))){
var G__36498 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__36499 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__36498;
node = G__36499;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__36506 = (function (){var arr__36245__auto__ = node__$1.pointers;
return (arr__36245__auto__[(arr__36245__auto__.length - (1))]);
})();
var G__36507 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__36508 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__36506;
path = G__36507;
level__$1 = G__36508;
continue;
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_36525 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_36525(this$,left,right);
}
});
...
var G__36557 = (left__$1 + (1));
var G__36558 = keys__$1;
var G__36559 = (idx__$1 + (1));
var G__36560 = new_acc;
left__$1 = G__36557;
keys__$1 = G__36558;
idx__$1 = G__36559;
acc = G__36560;
...
var G__36566 = new_left;
var G__36567 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__36568 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__36569 = new_acc;
left__$1 = G__36566;
keys__$1 = G__36567;
idx__$1 = G__36568;
acc = G__36569;
...
var G__36624 = (pos_36619 + piece_len_36623);
pos_36619 = G__36624;
continue;
...
var G__36635 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__36636 = (i + (1));
var G__36637 = e;
acc = G__36635;
i = G__36636;
...
break;
default:
var G__36650 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__36359,leaves){
...
var G__36651 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__36650;
shift = G__36651;
continue;
