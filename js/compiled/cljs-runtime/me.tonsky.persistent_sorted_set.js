...
if((((idx < arr_l)) && (((0) === (function (){var G__36315 = (arr[idx]);
var G__36317 = key;
return (cmp.cljs$core$IFn$_invoke$arity$2 ? cmp.cljs$core$IFn$_invoke$arity$2(G__36315,G__36317) : cmp.call(null,G__36315,G__36317));
})())))){
return idx;
} else {
return (-1);
...
var me$tonsky$persistent_sorted_set$INode$node_lookup$dyn_36429 = (function (_,cmp,key){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_lookup$dyn_36429(_,cmp,key);
}
});

var me$tonsky$persistent_sorted_set$INode$node_conj$dyn_36433 = (function (_,cmp,key){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_conj$dyn_36433(_,cmp,key);
}
});
...
var G__36520 = new_left;
var G__36521 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__36522 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__36523 = new_acc;
left__$1 = G__36520;
keys__$1 = G__36521;
idx__$1 = G__36522;
acc = G__36523;
...
var G__36559 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__36560 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__36559;
res = G__36560;
continue;
}
...
var G__36581 = (node.pointers[idx]);
var G__36582 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__36583 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__36581;
path = G__36582;
level = G__36583;
continue;
...
var pos_36598 = (0);
while(true){
var rest_36599 = (len - pos_36598);
if((rest_36599 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36598));
} else {
if((rest_36599 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36598,(pos_36598 + chunk_len)));

var G__36603 = (pos_36598 + chunk_len);
pos_36598 = G__36603;
continue;
} else {
var piece_len_36604 = (rest_36599 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36598,(pos_36598 + piece_len_36604)));

var G__36606 = (pos_36598 + piece_len_36604);
pos_36598 = G__36606;
continue;
...
var G__36617 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__36618 = (i + (1));
var G__36619 = e;
acc = G__36617;
i = G__36618;
...
break;
default:
var G__36631 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__36359,leaves){
...
var G__36632 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__36631;
shift = G__36632;
continue;
...
var G__36643 = (i__4737__auto___36641 + (1));
i__4737__auto___36641 = G__36643;
continue;
} else {
}
break;
